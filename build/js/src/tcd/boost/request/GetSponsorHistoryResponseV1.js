...
export default class GetSponsorHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:boost:request:get-sponsor-history-response:1-0-0', GetSponsorHistoryResponseV1,
      [],
      [
...
MessageResolver.register('tcd:boost:request:get-sponsor-history-response', GetSponsorHistoryResponseV1);
