...
export default class GetSponsorRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:boost:request:get-sponsor-request:1-0-0', GetSponsorRequestV1,
      [],
      [
...
MessageResolver.register('tcd:boost:request:get-sponsor-request', GetSponsorRequestV1);
