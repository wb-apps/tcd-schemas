...
export default class SearchSponsorsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:boost:request:search-sponsors-request:1-0-0', SearchSponsorsRequestV1,
      [],
      [
...
MessageResolver.register('tcd:boost:request:search-sponsors-request', SearchSponsorsRequestV1);
