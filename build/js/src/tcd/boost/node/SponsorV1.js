// @link https://schemas.truecrimedaily.com/json-schema/tcd/boost/node/sponsor/1-0-0.json#
...
export default class SponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:boost:node:sponsor:1-0-0', SponsorV1,
      [],
      [
...
MessageResolver.register('tcd:boost:node:sponsor', SponsorV1);
