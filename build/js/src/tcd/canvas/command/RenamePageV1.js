// @link https://schemas.truecrimedaily.com/json-schema/tcd/canvas/command/rename-page/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:canvas:command:rename-page:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:canvas:command:rename-page';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:canvas:command:rename-page:v1';
