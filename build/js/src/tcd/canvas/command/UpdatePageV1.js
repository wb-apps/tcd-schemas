...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:canvas:command:update-page:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:canvas:command:update-page';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:canvas:command:update-page:v1';
