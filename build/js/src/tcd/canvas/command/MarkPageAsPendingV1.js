// @link https://schemas.truecrimedaily.com/json-schema/tcd/canvas/command/mark-page-as-pending/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:canvas:command:mark-page-as-pending:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:canvas:command:mark-page-as-pending';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:canvas:command:mark-page-as-pending:v1';
