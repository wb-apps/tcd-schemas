...
export default class TumblrPostBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:canvas:block:tumblr-post-block:1-0-0', TumblrPostBlockV1,
      [],
      [
...
MessageResolver.register('tcd:canvas:block:tumblr-post-block', TumblrPostBlockV1);
