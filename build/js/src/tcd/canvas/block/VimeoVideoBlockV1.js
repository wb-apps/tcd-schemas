...
export default class VimeoVideoBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:canvas:block:vimeo-video-block:1-0-0', VimeoVideoBlockV1,
      [],
      [
...
MessageResolver.register('tcd:canvas:block:vimeo-video-block', VimeoVideoBlockV1);
