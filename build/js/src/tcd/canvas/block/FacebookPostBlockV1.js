...
export default class FacebookPostBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:canvas:block:facebook-post-block:1-0-0', FacebookPostBlockV1,
      [],
      [
...
MessageResolver.register('tcd:canvas:block:facebook-post-block', FacebookPostBlockV1);
