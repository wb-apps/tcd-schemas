// @link https://schemas.truecrimedaily.com/json-schema/tcd/canvas/block/text-block/1-0-0.json#
...
const M = TextBlockV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:canvas:block:text-block:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:canvas:block:text-block';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:text-block:v1';
