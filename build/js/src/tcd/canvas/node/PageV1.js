// @link https://schemas.truecrimedaily.com/json-schema/tcd/canvas/node/page/1-0-0.json#
...
export default class PageV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:canvas:node:page:1-0-0', PageV1,
      [],
      [
...
MessageResolver.register('tcd:canvas:node:page', PageV1);
