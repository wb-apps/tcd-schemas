...
export default class UpdateChannelV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:taxonomy:command:update-channel:1-0-0', UpdateChannelV1,
      [],
      [
...
MessageResolver.register('tcd:taxonomy:command:update-channel', UpdateChannelV1);
