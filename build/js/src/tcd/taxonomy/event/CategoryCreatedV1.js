...
export default class CategoryCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:taxonomy:event:category-created:1-0-0', CategoryCreatedV1,
      [],
      [
...
MessageResolver.register('tcd:taxonomy:event:category-created', CategoryCreatedV1);
