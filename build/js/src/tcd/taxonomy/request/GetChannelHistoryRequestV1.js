...
export default class GetChannelHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:taxonomy:request:get-channel-history-request:1-0-0', GetChannelHistoryRequestV1,
      [],
      [
...
MessageResolver.register('tcd:taxonomy:request:get-channel-history-request', GetChannelHistoryRequestV1);
