...
export default class GetChannelHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:taxonomy:request:get-channel-history-response:1-0-0', GetChannelHistoryResponseV1,
      [],
      [
...
MessageResolver.register('tcd:taxonomy:request:get-channel-history-response', GetChannelHistoryResponseV1);
