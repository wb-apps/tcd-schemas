...
export default class SuggestHashtagsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:taxonomy:request:suggest-hashtags-request:1-0-0', SuggestHashtagsRequestV1,
      [],
      [
...
MessageResolver.register('tcd:taxonomy:request:suggest-hashtags-request', SuggestHashtagsRequestV1);
