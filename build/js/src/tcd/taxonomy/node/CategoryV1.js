// @link https://schemas.truecrimedaily.com/json-schema/tcd/taxonomy/node/category/1-0-0.json#
...
export default class CategoryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:taxonomy:node:category:1-0-0', CategoryV1,
      [],
      [
...
MessageResolver.register('tcd:taxonomy:node:category', CategoryV1);
