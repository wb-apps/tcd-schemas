// @link https://schemas.truecrimedaily.com/json-schema/tcd/taxonomy/node/channel/1-0-0.json#
...
export default class ChannelV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:taxonomy:node:channel:1-0-0', ChannelV1,
      [],
      [
...
MessageResolver.register('tcd:taxonomy:node:channel', ChannelV1);
