// @link https://schemas.truecrimedaily.com/json-schema/tcd/sys/command/update-flagset/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:sys:command:update-flagset:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:sys:command:update-flagset';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:sys:command:update-flagset:v1';
