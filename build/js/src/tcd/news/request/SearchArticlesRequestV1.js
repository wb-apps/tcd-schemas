...
export default class SearchArticlesRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:news:request:search-articles-request:1-0-0', SearchArticlesRequestV1,
      [],
      [
...
MessageResolver.register('tcd:news:request:search-articles-request', SearchArticlesRequestV1);
