...
export default class ArticleUnlockedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:news:event:article-unlocked:1-0-0', ArticleUnlockedV1,
      [],
      [
...
MessageResolver.register('tcd:news:event:article-unlocked', ArticleUnlockedV1);
