...
export default class ArticleScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:news:event:article-scheduled:1-0-0', ArticleScheduledV1,
      [],
      [
...
MessageResolver.register('tcd:news:event:article-scheduled', ArticleScheduledV1);
