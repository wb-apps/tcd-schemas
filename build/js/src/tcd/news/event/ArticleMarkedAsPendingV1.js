...
export default class ArticleMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:news:event:article-marked-as-pending:1-0-0', ArticleMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('tcd:news:event:article-marked-as-pending', ArticleMarkedAsPendingV1);
