...
export default class ArticleStatsCollectedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:news:event:article-stats-collected:1-0-0', ArticleStatsCollectedV1,
      [],
      [
...
MessageResolver.register('tcd:news:event:article-stats-collected', ArticleStatsCollectedV1);
