// @link https://schemas.truecrimedaily.com/json-schema/tcd/news/command/remove-article-slotting/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:news:command:remove-article-slotting:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:news:command:remove-article-slotting';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:news:command:remove-article-slotting:v1';
