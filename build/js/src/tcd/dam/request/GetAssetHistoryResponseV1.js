...
export default class GetAssetHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:dam:request:get-asset-history-response:1-0-0', GetAssetHistoryResponseV1,
      [],
      [
...
MessageResolver.register('tcd:dam:request:get-asset-history-response', GetAssetHistoryResponseV1);
