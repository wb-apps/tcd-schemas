...
export default class GetAssetResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:dam:request:get-asset-response:1-0-0', GetAssetResponseV1,
      [],
      [
...
MessageResolver.register('tcd:dam:request:get-asset-response', GetAssetResponseV1);
