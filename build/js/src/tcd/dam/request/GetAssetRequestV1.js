...
export default class GetAssetRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:dam:request:get-asset-request:1-0-0', GetAssetRequestV1,
      [],
      [
...
MessageResolver.register('tcd:dam:request:get-asset-request', GetAssetRequestV1);
