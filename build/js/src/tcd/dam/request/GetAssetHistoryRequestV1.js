...
export default class GetAssetHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:dam:request:get-asset-history-request:1-0-0', GetAssetHistoryRequestV1,
      [],
      [
...
MessageResolver.register('tcd:dam:request:get-asset-history-request', GetAssetHistoryRequestV1);
