...
export default class GetUploadUrlsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:dam:request:get-upload-urls-request:1-0-0', GetUploadUrlsRequestV1,
      [],
      [
...
MessageResolver.register('tcd:dam:request:get-upload-urls-request', GetUploadUrlsRequestV1);
