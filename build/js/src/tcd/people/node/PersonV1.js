// @link https://schemas.truecrimedaily.com/json-schema/tcd/people/node/person/1-0-0.json#
...
export default class PersonV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:people:node:person:1-0-0', PersonV1,
      [],
      [
...
MessageResolver.register('tcd:people:node:person', PersonV1);
