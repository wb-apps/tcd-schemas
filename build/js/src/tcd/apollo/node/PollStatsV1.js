// @link https://schemas.truecrimedaily.com/json-schema/tcd/apollo/node/poll-stats/1-0-0.json#
...
export default class PollStatsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:apollo:node:poll-stats:1-0-0', PollStatsV1,
      [],
      [
...
MessageResolver.register('tcd:apollo:node:poll-stats', PollStatsV1);
