// @link https://schemas.truecrimedaily.com/json-schema/tcd/apollo/node/poll/1-0-0.json#
...
export default class PollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:apollo:node:poll:1-0-0', PollV1,
      [],
      [
...
MessageResolver.register('tcd:apollo:node:poll', PollV1);
