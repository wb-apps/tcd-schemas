...
export default class PollUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:apollo:event:poll-unpublished:1-0-0', PollUnpublishedV1,
      [],
      [
...
MessageResolver.register('tcd:apollo:event:poll-unpublished', PollUnpublishedV1);
