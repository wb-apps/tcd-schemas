// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/node/ios-app/1-0-0.json#
...
export default class IosAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:iam:node:ios-app:1-0-0', IosAppV1,
      [],
      [
...
MessageResolver.register('tcd:iam:node:ios-app', IosAppV1);
