// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/node/slack-app/1-0-0.json#
...
export default class SlackAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:iam:node:slack-app:1-0-0', SlackAppV1,
      [],
      [
...
MessageResolver.register('tcd:iam:node:slack-app', SlackAppV1);
