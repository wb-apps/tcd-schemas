// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/node/browser-app/1-0-0.json#
...
export default class BrowserAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:iam:node:browser-app:1-0-0', BrowserAppV1,
      [],
      [
...
MessageResolver.register('tcd:iam:node:browser-app', BrowserAppV1);
