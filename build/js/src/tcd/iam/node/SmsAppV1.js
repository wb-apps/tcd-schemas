...
const M = SmsAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:iam:node:sms-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:iam:node:sms-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:iam:node:sms-app:v1';
