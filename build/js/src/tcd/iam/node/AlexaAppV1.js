// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/node/alexa-app/1-0-0.json#
...
export default class AlexaAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:iam:node:alexa-app:1-0-0', AlexaAppV1,
      [],
      [
...
MessageResolver.register('tcd:iam:node:alexa-app', AlexaAppV1);
