// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/node/user/1-0-0.json#
...
export default class UserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:iam:node:user:1-0-0', UserV1,
      [],
      [
...
MessageResolver.register('tcd:iam:node:user', UserV1);
