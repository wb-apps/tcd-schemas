// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/node/android-app/1-0-0.json#
...
export default class AndroidAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:iam:node:android-app:1-0-0', AndroidAppV1,
      [],
      [
...
MessageResolver.register('tcd:iam:node:android-app', AndroidAppV1);
