// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/node/apple-news-app/1-0-0.json#
...
export default class AppleNewsAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:iam:node:apple-news-app:1-0-0', AppleNewsAppV1,
      [],
      [
...
MessageResolver.register('tcd:iam:node:apple-news-app', AppleNewsAppV1);
