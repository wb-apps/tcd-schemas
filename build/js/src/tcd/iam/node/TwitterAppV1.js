// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/node/twitter-app/1-0-0.json#
...
export default class TwitterAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:iam:node:twitter-app:1-0-0', TwitterAppV1,
      [],
      [
...
MessageResolver.register('tcd:iam:node:twitter-app', TwitterAppV1);
