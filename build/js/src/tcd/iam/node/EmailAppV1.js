// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/node/email-app/1-0-0.json#
...
export default class EmailAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:iam:node:email-app:1-0-0', EmailAppV1,
      [],
      [
...
MessageResolver.register('tcd:iam:node:email-app', EmailAppV1);
