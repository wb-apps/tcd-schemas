...
export default class SearchUsersRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:iam:request:search-users-request:1-0-0', SearchUsersRequestV1,
      [],
      [
...
MessageResolver.register('tcd:iam:request:search-users-request', SearchUsersRequestV1);
