// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/command/create-app/1-0-0.json#
...
const M = CreateAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:iam:command:create-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:iam:command:create-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:iam:command:create-app:v1';
