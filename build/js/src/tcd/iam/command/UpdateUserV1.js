...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:iam:command:update-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:iam:command:update-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:iam:command:update-user:v1';
