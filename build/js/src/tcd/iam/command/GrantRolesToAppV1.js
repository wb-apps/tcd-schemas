// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/command/grant-roles-to-app/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:iam:command:grant-roles-to-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:iam:command:grant-roles-to-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:iam:command:grant-roles-to-app:v1';
