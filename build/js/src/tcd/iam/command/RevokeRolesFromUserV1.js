// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/command/revoke-roles-from-user/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:iam:command:revoke-roles-from-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:iam:command:revoke-roles-from-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:iam:command:revoke-roles-from-user:v1';
