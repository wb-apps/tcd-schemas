// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/command/delete-app/1-0-0.json#
...
const M = DeleteAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:iam:command:delete-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:iam:command:delete-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:iam:command:delete-app:v1';
