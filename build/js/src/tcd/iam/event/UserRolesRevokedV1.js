// @link https://schemas.truecrimedaily.com/json-schema/tcd/iam/event/user-roles-revoked/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:iam:event:user-roles-revoked:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:iam:event:user-roles-revoked';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:iam:event:user-roles-revoked:v1';
