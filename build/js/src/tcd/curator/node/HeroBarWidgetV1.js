// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/hero-bar-widget/1-0-0.json#
...
export default class HeroBarWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:hero-bar-widget:1-0-0', HeroBarWidgetV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:hero-bar-widget', HeroBarWidgetV1);
