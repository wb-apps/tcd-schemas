// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/slider-widget/1-0-0.json#
...
export default class SliderWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:slider-widget:1-0-0', SliderWidgetV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:slider-widget', SliderWidgetV1);
