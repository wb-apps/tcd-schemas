// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/asset-teaser/1-0-0.json#
...
export default class AssetTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:asset-teaser:1-0-0', AssetTeaserV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:asset-teaser', AssetTeaserV1);
