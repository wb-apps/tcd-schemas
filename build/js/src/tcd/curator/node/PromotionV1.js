// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/promotion/1-0-0.json#
...
export default class PromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:promotion:1-0-0', PromotionV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:promotion', PromotionV1);
