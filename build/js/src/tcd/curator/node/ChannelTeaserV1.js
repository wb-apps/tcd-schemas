// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/channel-teaser/1-0-0.json#
...
export default class ChannelTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:channel-teaser:1-0-0', ChannelTeaserV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:channel-teaser', ChannelTeaserV1);
