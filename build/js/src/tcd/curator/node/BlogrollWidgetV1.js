// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/blogroll-widget/1-0-0.json#
...
export default class BlogrollWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:blogroll-widget:1-0-0', BlogrollWidgetV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:blogroll-widget', BlogrollWidgetV1);
