// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/category-teaser/1-0-0.json#
...
export default class CategoryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:category-teaser:1-0-0', CategoryTeaserV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:category-teaser', CategoryTeaserV1);
