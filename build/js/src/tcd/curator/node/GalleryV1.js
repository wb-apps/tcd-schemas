// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/gallery/1-0-0.json#
...
export default class GalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:gallery:1-0-0', GalleryV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:gallery', GalleryV1);
