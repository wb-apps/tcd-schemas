// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/gridler-widget/1-0-0.json#
...
export default class GridlerWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:gridler-widget:1-0-0', GridlerWidgetV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:gridler-widget', GridlerWidgetV1);
