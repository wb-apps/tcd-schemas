// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/showtimes-widget/1-0-0.json#
...
export default class ShowtimesWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:showtimes-widget:1-0-0', ShowtimesWidgetV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:showtimes-widget', ShowtimesWidgetV1);
