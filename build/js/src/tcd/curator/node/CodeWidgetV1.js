// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/code-widget/1-0-0.json#
...
export default class CodeWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:code-widget:1-0-0', CodeWidgetV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:code-widget', CodeWidgetV1);
