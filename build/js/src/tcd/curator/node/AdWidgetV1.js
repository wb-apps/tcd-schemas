// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/ad-widget/1-0-0.json#
...
export default class AdWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:ad-widget:1-0-0', AdWidgetV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:ad-widget', AdWidgetV1);
