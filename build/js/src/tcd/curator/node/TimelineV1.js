// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/timeline/1-0-0.json#
...
export default class TimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:timeline:1-0-0', TimelineV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:timeline', TimelineV1);
