// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/media-list-widget/1-0-0.json#
...
export default class MediaListWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:media-list-widget:1-0-0', MediaListWidgetV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:media-list-widget', MediaListWidgetV1);
