// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/video-teaser/1-0-0.json#
...
export default class VideoTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:video-teaser:1-0-0', VideoTeaserV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:video-teaser', VideoTeaserV1);
