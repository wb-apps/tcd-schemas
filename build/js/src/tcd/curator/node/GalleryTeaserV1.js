// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/gallery-teaser/1-0-0.json#
...
export default class GalleryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:gallery-teaser:1-0-0', GalleryTeaserV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:gallery-teaser', GalleryTeaserV1);
