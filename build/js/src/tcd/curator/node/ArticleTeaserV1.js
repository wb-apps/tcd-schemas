// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/article-teaser/1-0-0.json#
...
export default class ArticleTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:article-teaser:1-0-0', ArticleTeaserV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:article-teaser', ArticleTeaserV1);
