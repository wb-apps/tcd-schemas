// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/poll-teaser/1-0-0.json#
...
export default class PollTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:poll-teaser:1-0-0', PollTeaserV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:poll-teaser', PollTeaserV1);
