// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/timeline-teaser/1-0-0.json#
...
export default class TimelineTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:timeline-teaser:1-0-0', TimelineTeaserV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:timeline-teaser', TimelineTeaserV1);
