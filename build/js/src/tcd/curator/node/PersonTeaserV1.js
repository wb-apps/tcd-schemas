// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/person-teaser/1-0-0.json#
...
export default class PersonTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:person-teaser:1-0-0', PersonTeaserV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:person-teaser', PersonTeaserV1);
