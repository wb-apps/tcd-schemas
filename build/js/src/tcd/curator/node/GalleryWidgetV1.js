// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/gallery-widget/1-0-0.json#
...
export default class GalleryWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:gallery-widget:1-0-0', GalleryWidgetV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:gallery-widget', GalleryWidgetV1);
