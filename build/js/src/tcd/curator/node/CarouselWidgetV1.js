// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/carousel-widget/1-0-0.json#
...
export default class CarouselWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:carousel-widget:1-0-0', CarouselWidgetV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:carousel-widget', CarouselWidgetV1);
