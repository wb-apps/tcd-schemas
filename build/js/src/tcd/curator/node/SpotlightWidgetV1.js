// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/spotlight-widget/1-0-0.json#
...
export default class SpotlightWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:spotlight-widget:1-0-0', SpotlightWidgetV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:spotlight-widget', SpotlightWidgetV1);
