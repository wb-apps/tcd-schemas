// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/page-teaser/1-0-0.json#
...
export default class PageTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:page-teaser:1-0-0', PageTeaserV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:page-teaser', PageTeaserV1);
