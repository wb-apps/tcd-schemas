// @link https://schemas.truecrimedaily.com/json-schema/tcd/curator/node/youtube-video-teaser/1-0-0.json#
...
export default class YoutubeVideoTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:node:youtube-video-teaser:1-0-0', YoutubeVideoTeaserV1,
      [],
      [
...
MessageResolver.register('tcd:curator:node:youtube-video-teaser', YoutubeVideoTeaserV1);
