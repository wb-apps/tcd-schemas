...
export default class TeaserScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:event:teaser-scheduled:1-0-0', TeaserScheduledV1,
      [],
      [
...
MessageResolver.register('tcd:curator:event:teaser-scheduled', TeaserScheduledV1);
