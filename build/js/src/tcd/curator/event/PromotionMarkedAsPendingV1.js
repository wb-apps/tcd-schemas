...
export default class PromotionMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:event:promotion-marked-as-pending:1-0-0', PromotionMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('tcd:curator:event:promotion-marked-as-pending', PromotionMarkedAsPendingV1);
