...
export default class TeaserMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:event:teaser-marked-as-draft:1-0-0', TeaserMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('tcd:curator:event:teaser-marked-as-draft', TeaserMarkedAsDraftV1);
