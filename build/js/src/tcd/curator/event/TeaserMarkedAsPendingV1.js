...
export default class TeaserMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:event:teaser-marked-as-pending:1-0-0', TeaserMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('tcd:curator:event:teaser-marked-as-pending', TeaserMarkedAsPendingV1);
