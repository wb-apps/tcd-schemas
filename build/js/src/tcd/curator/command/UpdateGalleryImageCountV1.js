...
export default class UpdateGalleryImageCountV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:command:update-gallery-image-count:1-0-0', UpdateGalleryImageCountV1,
      [],
      [
...
MessageResolver.register('tcd:curator:command:update-gallery-image-count', UpdateGalleryImageCountV1);
