...
export default class UpdatePromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:command:update-promotion:1-0-0', UpdatePromotionV1,
      [],
      [
...
MessageResolver.register('tcd:curator:command:update-promotion', UpdatePromotionV1);
