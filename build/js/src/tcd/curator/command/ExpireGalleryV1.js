...
export default class ExpireGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:command:expire-gallery:1-0-0', ExpireGalleryV1,
      [],
      [
...
MessageResolver.register('tcd:curator:command:expire-gallery', ExpireGalleryV1);
