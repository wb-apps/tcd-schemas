...
export default class PublishTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:command:publish-timeline:1-0-0', PublishTimelineV1,
      [],
      [
...
MessageResolver.register('tcd:curator:command:publish-timeline', PublishTimelineV1);
