...
export default class RenderWidgetRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:request:render-widget-request:1-0-0', RenderWidgetRequestV1,
      [],
      [
...
MessageResolver.register('tcd:curator:request:render-widget-request', RenderWidgetRequestV1);
