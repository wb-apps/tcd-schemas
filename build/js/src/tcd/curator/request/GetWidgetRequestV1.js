...
export default class GetWidgetRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:request:get-widget-request:1-0-0', GetWidgetRequestV1,
      [],
      [
...
MessageResolver.register('tcd:curator:request:get-widget-request', GetWidgetRequestV1);
