...
export default class GetGalleryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:curator:request:get-gallery-request:1-0-0', GetGalleryRequestV1,
      [],
      [
...
MessageResolver.register('tcd:curator:request:get-gallery-request', GetGalleryRequestV1);
