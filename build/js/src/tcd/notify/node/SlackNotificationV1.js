// @link https://schemas.truecrimedaily.com/json-schema/tcd/notify/node/slack-notification/1-0-0.json#
...
export default class SlackNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:notify:node:slack-notification:1-0-0', SlackNotificationV1,
      [],
      [
...
MessageResolver.register('tcd:notify:node:slack-notification', SlackNotificationV1);
