// @link https://schemas.truecrimedaily.com/json-schema/tcd/notify/node/sms-notification/1-0-0.json#
...
export default class SmsNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:notify:node:sms-notification:1-0-0', SmsNotificationV1,
      [],
      [
...
MessageResolver.register('tcd:notify:node:sms-notification', SmsNotificationV1);
