// @link https://schemas.truecrimedaily.com/json-schema/tcd/notify/node/email-notification/1-0-0.json#
...
export default class EmailNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:notify:node:email-notification:1-0-0', EmailNotificationV1,
      [],
      [
...
MessageResolver.register('tcd:notify:node:email-notification', EmailNotificationV1);
