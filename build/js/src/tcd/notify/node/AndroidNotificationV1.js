// @link https://schemas.truecrimedaily.com/json-schema/tcd/notify/node/android-notification/1-0-0.json#
...
export default class AndroidNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:notify:node:android-notification:1-0-0', AndroidNotificationV1,
      [],
      [
...
MessageResolver.register('tcd:notify:node:android-notification', AndroidNotificationV1);
