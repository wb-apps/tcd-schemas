// @link https://schemas.truecrimedaily.com/json-schema/tcd/notify/node/ios-notification/1-0-0.json#
...
export default class IosNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:notify:node:ios-notification:1-0-0', IosNotificationV1,
      [],
      [
...
MessageResolver.register('tcd:notify:node:ios-notification', IosNotificationV1);
