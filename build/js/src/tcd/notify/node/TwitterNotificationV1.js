// @link https://schemas.truecrimedaily.com/json-schema/tcd/notify/node/twitter-notification/1-0-0.json#
...
export default class TwitterNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:notify:node:twitter-notification:1-0-0', TwitterNotificationV1,
      [],
      [
...
MessageResolver.register('tcd:notify:node:twitter-notification', TwitterNotificationV1);
