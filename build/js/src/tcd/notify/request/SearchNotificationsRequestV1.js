...
export default class SearchNotificationsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:notify:request:search-notifications-request:1-0-0', SearchNotificationsRequestV1,
      [],
      [
...
MessageResolver.register('tcd:notify:request:search-notifications-request', SearchNotificationsRequestV1);
