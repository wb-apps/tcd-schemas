...
export default class NotificationUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:notify:event:notification-updated:1-0-0', NotificationUpdatedV1,
      [],
      [
...
MessageResolver.register('tcd:notify:event:notification-updated', NotificationUpdatedV1);
