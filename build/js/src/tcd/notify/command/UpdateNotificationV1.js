// @link https://schemas.truecrimedaily.com/json-schema/tcd/notify/command/update-notification/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tcd:notify:command:update-notification:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tcd:notify:command:update-notification';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tcd:notify:command:update-notification:v1';
