...
export default class CreateNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:notify:command:create-notification:1-0-0', CreateNotificationV1,
      [],
      [
...
MessageResolver.register('tcd:notify:command:create-notification', CreateNotificationV1);
