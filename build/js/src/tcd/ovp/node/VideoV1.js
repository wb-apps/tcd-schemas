// @link https://schemas.truecrimedaily.com/json-schema/tcd/ovp/node/video/1-0-0.json#
...
export default class VideoV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:ovp:node:video:1-0-0', VideoV1,
      [],
      [
...
MessageResolver.register('tcd:ovp:node:video', VideoV1);
