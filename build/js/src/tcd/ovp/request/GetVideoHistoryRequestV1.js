...
export default class GetVideoHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tcd:ovp:request:get-video-history-request:1-0-0', GetVideoHistoryRequestV1,
      [],
      [
...
MessageResolver.register('tcd:ovp:request:get-video-history-request', GetVideoHistoryRequestV1);
