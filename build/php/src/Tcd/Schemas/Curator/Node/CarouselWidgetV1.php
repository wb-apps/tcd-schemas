...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:carousel-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:carousel-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:carousel-widget:v1';
    const MIXINS = [
