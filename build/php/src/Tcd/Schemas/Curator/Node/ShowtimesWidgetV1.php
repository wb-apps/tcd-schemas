...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:showtimes-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:showtimes-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:showtimes-widget:v1';
    const MIXINS = [
