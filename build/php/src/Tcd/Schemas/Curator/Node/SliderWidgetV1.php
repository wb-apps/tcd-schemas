...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:slider-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:slider-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:slider-widget:v1';
    const MIXINS = [
