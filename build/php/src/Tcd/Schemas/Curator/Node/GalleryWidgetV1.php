...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:gallery-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:gallery-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:gallery-widget:v1';
    const MIXINS = [
