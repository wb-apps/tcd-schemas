...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:promotion:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:promotion';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:promotion:v1';
    const MIXINS = [
