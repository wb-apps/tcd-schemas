...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:code-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:code-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:code-widget:v1';
    const MIXINS = [
