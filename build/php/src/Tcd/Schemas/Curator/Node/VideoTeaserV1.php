...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:video-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:video-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:video-teaser:v1';
    const MIXINS = [
