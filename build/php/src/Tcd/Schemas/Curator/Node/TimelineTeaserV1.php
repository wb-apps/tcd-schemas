...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:timeline-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:timeline-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:timeline-teaser:v1';
    const MIXINS = [
