...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:gallery-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:gallery-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:gallery-teaser:v1';
    const MIXINS = [
