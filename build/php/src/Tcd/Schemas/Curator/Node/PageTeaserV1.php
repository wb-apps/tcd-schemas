...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:page-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:page-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:page-teaser:v1';
    const MIXINS = [
