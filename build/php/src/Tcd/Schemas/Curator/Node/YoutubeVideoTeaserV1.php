...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:youtube-video-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:youtube-video-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:youtube-video-teaser:v1';
    const MIXINS = [
