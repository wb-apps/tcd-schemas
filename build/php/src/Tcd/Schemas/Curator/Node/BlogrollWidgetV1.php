...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:blogroll-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:blogroll-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:blogroll-widget:v1';
    const MIXINS = [
