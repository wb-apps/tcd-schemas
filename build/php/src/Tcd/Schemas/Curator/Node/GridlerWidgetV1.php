...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:gridler-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:gridler-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:gridler-widget:v1';
    const MIXINS = [
