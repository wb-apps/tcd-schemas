...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:article-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:article-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:article-teaser:v1';
    const MIXINS = [
