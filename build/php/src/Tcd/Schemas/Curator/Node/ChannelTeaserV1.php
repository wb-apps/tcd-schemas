...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:channel-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:channel-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:channel-teaser:v1';
    const MIXINS = [
