...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:asset-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:asset-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:asset-teaser:v1';
    const MIXINS = [
