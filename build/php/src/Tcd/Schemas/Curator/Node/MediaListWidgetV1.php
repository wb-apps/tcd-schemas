...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:media-list-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:media-list-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:media-list-widget:v1';
    const MIXINS = [
