...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:link-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:link-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:link-teaser:v1';
    const MIXINS = [
