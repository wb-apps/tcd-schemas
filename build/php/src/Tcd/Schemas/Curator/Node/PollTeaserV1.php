...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:poll-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:poll-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:poll-teaser:v1';
    const MIXINS = [
