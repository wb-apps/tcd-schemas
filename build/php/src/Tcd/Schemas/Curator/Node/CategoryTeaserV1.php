...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:category-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:category-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:category-teaser:v1';
    const MIXINS = [
