...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:hero-bar-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:hero-bar-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:hero-bar-widget:v1';
    const MIXINS = [
