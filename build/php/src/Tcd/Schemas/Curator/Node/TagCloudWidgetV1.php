...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:tag-cloud-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:tag-cloud-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:tag-cloud-widget:v1';
    const MIXINS = [
