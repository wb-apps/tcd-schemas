...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:ad-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:ad-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:ad-widget:v1';
    const MIXINS = [
