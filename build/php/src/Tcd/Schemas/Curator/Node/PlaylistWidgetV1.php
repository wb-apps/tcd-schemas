...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:playlist-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:playlist-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:playlist-widget:v1';
    const MIXINS = [
