...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:tetris-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:tetris-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:tetris-widget:v1';
    const MIXINS = [
