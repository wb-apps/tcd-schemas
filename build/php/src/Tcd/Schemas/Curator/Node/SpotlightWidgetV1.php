...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:spotlight-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:spotlight-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:spotlight-widget:v1';
    const MIXINS = [
