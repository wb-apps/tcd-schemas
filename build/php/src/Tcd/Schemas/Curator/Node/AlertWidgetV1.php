...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:alert-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:alert-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:alert-widget:v1';
    const MIXINS = [
