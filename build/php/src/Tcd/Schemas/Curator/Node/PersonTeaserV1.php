...
{
    const SCHEMA_ID = 'pbj:tcd:curator:node:person-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:node:person-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:node:person-teaser:v1';
    const MIXINS = [
