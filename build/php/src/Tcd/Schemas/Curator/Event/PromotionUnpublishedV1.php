...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:promotion-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:promotion-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:promotion-unpublished:v1';
    const MIXINS = [
