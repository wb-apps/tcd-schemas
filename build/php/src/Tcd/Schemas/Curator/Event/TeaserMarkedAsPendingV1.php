...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:teaser-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:teaser-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:teaser-marked-as-pending:v1';
    const MIXINS = [
