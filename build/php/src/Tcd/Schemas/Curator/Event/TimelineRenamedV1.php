...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:timeline-renamed:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:timeline-renamed';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:timeline-renamed:v1';
    const MIXINS = [
