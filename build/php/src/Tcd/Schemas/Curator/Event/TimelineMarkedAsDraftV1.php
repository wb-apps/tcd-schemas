...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:timeline-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:timeline-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:timeline-marked-as-draft:v1';
    const MIXINS = [
