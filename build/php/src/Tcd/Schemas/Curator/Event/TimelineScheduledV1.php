...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:timeline-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:timeline-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:timeline-scheduled:v1';
    const MIXINS = [
