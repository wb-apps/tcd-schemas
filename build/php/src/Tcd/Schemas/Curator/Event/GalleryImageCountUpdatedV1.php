...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:gallery-image-count-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:gallery-image-count-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:gallery-image-count-updated:v1';
    const MIXINS = [
