...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:widget-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:widget-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:widget-created:v1';
    const MIXINS = [
