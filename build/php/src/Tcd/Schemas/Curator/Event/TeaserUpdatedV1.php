...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:teaser-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:teaser-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:teaser-updated:v1';
    const MIXINS = [
