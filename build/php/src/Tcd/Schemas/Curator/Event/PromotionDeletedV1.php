...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:promotion-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:promotion-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:promotion-deleted:v1';
    const MIXINS = [
