...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:gallery-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:gallery-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:gallery-scheduled:v1';
    const MIXINS = [
