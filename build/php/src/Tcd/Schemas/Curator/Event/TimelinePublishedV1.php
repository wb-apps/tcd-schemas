...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:timeline-published:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:timeline-published';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:timeline-published:v1';
    const MIXINS = [
