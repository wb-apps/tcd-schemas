...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:teaser-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:teaser-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:teaser-scheduled:v1';
    const MIXINS = [
