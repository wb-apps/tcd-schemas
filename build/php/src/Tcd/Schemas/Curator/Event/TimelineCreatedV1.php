...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:timeline-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:timeline-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:timeline-created:v1';
    const MIXINS = [
