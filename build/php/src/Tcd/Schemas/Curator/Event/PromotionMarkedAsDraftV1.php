...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:promotion-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:promotion-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:promotion-marked-as-draft:v1';
    const MIXINS = [
