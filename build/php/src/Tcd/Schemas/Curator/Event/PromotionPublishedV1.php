...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:promotion-published:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:promotion-published';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:promotion-published:v1';
    const MIXINS = [
