...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:teaser-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:teaser-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:teaser-deleted:v1';
    const MIXINS = [
