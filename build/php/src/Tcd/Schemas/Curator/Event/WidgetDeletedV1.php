...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:widget-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:widget-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:widget-deleted:v1';
    const MIXINS = [
