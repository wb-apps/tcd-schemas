...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:gallery-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:gallery-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:gallery-deleted:v1';
    const MIXINS = [
