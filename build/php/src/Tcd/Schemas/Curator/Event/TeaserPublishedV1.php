...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:teaser-published:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:teaser-published';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:teaser-published:v1';
    const MIXINS = [
