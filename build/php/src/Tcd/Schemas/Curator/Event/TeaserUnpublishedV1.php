...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:teaser-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:teaser-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:teaser-unpublished:v1';
    const MIXINS = [
