...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:teaser-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:teaser-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:teaser-created:v1';
    const MIXINS = [
