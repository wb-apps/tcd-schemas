...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:gallery-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:gallery-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:gallery-marked-as-draft:v1';
    const MIXINS = [
