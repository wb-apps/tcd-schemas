...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:widget-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:widget-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:widget-updated:v1';
    const MIXINS = [
