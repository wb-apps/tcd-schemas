...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:gallery-expired:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:gallery-expired';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:gallery-expired:v1';
    const MIXINS = [
