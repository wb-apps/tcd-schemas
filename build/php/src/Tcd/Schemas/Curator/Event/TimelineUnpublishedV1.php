...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:timeline-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:timeline-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:timeline-unpublished:v1';
    const MIXINS = [
