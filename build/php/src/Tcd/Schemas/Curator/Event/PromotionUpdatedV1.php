...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:promotion-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:promotion-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:promotion-updated:v1';
    const MIXINS = [
