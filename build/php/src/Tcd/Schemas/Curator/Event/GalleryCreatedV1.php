...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:gallery-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:gallery-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:gallery-created:v1';
    const MIXINS = [
