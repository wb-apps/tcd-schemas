...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:teaser-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:teaser-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:teaser-slotting-removed:v1';
    const MIXINS = [
