...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:timeline-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:timeline-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:timeline-updated:v1';
    const MIXINS = [
