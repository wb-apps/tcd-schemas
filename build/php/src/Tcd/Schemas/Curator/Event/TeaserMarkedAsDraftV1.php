...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:teaser-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:teaser-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:teaser-marked-as-draft:v1';
    const MIXINS = [
