...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:teaser-expired:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:teaser-expired';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:teaser-expired:v1';
    const MIXINS = [
