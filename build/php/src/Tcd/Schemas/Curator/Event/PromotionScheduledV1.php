...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:promotion-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:promotion-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:promotion-scheduled:v1';
    const MIXINS = [
