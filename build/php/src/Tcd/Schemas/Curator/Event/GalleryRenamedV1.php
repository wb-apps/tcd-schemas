...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:gallery-renamed:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:gallery-renamed';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:gallery-renamed:v1';
    const MIXINS = [
