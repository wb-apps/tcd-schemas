...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:timeline-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:timeline-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:timeline-deleted:v1';
    const MIXINS = [
