...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:gallery-published:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:gallery-published';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:gallery-published:v1';
    const MIXINS = [
