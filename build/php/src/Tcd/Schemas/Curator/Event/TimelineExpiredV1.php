...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:timeline-expired:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:timeline-expired';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:timeline-expired:v1';
    const MIXINS = [
