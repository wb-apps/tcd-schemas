...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:promotion-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:promotion-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:promotion-created:v1';
    const MIXINS = [
