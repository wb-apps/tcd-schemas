...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:promotion-expired:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:promotion-expired';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:promotion-expired:v1';
    const MIXINS = [
