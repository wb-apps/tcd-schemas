...
{
    const SCHEMA_ID = 'pbj:tcd:curator:event:gallery-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:event:gallery-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:event:gallery-unpublished:v1';
    const MIXINS = [
