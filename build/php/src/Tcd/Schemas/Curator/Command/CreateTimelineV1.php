...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:create-timeline:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:create-timeline';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:create-timeline:v1';
    const MIXINS = [
