...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:create-promotion:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:create-promotion';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:create-promotion:v1';
    const MIXINS = [
