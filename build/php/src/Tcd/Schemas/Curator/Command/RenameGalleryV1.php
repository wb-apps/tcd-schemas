...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:rename-gallery:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:rename-gallery';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:rename-gallery:v1';
    const MIXINS = [
