...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:delete-promotion:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:delete-promotion';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:delete-promotion:v1';
    const MIXINS = [
