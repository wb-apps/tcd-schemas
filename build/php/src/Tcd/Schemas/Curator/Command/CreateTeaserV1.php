...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:create-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:create-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:create-teaser:v1';
    const MIXINS = [
