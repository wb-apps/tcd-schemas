...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:delete-gallery:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:delete-gallery';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:delete-gallery:v1';
    const MIXINS = [
