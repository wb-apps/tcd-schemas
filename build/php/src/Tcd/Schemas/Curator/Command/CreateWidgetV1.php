...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:create-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:create-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:create-widget:v1';
    const MIXINS = [
