...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:unpublish-timeline:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:unpublish-timeline';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:unpublish-timeline:v1';
    const MIXINS = [
