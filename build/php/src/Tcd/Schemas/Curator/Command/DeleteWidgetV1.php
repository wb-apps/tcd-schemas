...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:delete-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:delete-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:delete-widget:v1';
    const MIXINS = [
