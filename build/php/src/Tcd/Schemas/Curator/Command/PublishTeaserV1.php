...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:publish-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:publish-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:publish-teaser:v1';
    const MIXINS = [
