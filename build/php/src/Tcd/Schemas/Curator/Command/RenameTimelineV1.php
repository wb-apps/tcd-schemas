...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:rename-timeline:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:rename-timeline';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:rename-timeline:v1';
    const MIXINS = [
