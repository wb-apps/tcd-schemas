...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:expire-gallery:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:expire-gallery';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:expire-gallery:v1';
    const MIXINS = [
