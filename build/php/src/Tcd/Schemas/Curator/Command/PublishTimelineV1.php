...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:publish-timeline:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:publish-timeline';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:publish-timeline:v1';
    const MIXINS = [
