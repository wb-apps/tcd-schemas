...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:sync-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:sync-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:sync-teaser:v1';
    const MIXINS = [
