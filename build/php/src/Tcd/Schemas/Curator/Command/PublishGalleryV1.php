...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:publish-gallery:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:publish-gallery';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:publish-gallery:v1';
    const MIXINS = [
