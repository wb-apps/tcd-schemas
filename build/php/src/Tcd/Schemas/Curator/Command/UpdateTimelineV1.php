...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:update-timeline:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:update-timeline';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:update-timeline:v1';
    const MIXINS = [
