...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:unpublish-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:unpublish-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:unpublish-teaser:v1';
    const MIXINS = [
