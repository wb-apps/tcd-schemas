...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:create-gallery:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:create-gallery';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:create-gallery:v1';
    const MIXINS = [
