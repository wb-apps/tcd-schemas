...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:unpublish-gallery:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:unpublish-gallery';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:unpublish-gallery:v1';
    const MIXINS = [
