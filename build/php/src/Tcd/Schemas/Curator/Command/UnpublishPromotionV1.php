...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:unpublish-promotion:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:unpublish-promotion';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:unpublish-promotion:v1';
    const MIXINS = [
