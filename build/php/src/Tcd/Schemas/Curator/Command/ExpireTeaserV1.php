...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:expire-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:expire-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:expire-teaser:v1';
    const MIXINS = [
