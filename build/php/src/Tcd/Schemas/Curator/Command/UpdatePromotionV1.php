...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:update-promotion:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:update-promotion';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:update-promotion:v1';
    const MIXINS = [
