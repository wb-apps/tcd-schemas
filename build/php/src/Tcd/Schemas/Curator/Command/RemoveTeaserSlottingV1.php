...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:remove-teaser-slotting:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:remove-teaser-slotting';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:remove-teaser-slotting:v1';
    const MIXINS = [
