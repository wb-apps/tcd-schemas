...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:update-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:update-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:update-teaser:v1';
    const MIXINS = [
