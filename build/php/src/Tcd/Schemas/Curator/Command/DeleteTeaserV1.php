...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:delete-teaser:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:delete-teaser';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:delete-teaser:v1';
    const MIXINS = [
