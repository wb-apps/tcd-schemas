...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:expire-promotion:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:expire-promotion';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:expire-promotion:v1';
    const MIXINS = [
