...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:update-gallery-image-count:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:update-gallery-image-count';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:update-gallery-image-count:v1';
    const MIXINS = [
