...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:expire-timeline:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:expire-timeline';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:expire-timeline:v1';
    const MIXINS = [
