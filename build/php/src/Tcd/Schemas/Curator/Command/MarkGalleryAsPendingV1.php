...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:mark-gallery-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:mark-gallery-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:mark-gallery-as-pending:v1';
    const MIXINS = [
