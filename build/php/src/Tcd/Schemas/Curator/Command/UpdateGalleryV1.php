...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:update-gallery:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:update-gallery';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:update-gallery:v1';
    const MIXINS = [
