...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:update-widget:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:update-widget';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:update-widget:v1';
    const MIXINS = [
