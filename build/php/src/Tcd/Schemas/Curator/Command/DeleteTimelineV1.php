...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:delete-timeline:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:delete-timeline';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:delete-timeline:v1';
    const MIXINS = [
