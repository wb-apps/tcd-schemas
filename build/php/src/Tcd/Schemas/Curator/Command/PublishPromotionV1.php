...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:publish-promotion:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:publish-promotion';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:publish-promotion:v1';
    const MIXINS = [
