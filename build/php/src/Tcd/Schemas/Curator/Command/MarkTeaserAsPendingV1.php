...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:mark-teaser-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:mark-teaser-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:mark-teaser-as-pending:v1';
    const MIXINS = [
