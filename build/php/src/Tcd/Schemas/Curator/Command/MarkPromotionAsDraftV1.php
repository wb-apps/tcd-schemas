...
{
    const SCHEMA_ID = 'pbj:tcd:curator:command:mark-promotion-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:command:mark-promotion-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:command:mark-promotion-as-draft:v1';
    const MIXINS = [
