...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:search-promotions-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:search-promotions-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:search-promotions-response:v1';
    const MIXINS = [
