...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:render-widget-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:render-widget-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:render-widget-response:v1';
    const MIXINS = [
