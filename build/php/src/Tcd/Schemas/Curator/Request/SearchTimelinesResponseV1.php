...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:search-timelines-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:search-timelines-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:search-timelines-response:v1';
    const MIXINS = [
