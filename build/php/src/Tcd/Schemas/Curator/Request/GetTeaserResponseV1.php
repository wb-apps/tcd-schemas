...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:get-teaser-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:get-teaser-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:get-teaser-response:v1';
    const MIXINS = [
