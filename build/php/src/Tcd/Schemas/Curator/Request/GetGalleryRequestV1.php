...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:get-gallery-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:get-gallery-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:get-gallery-request:v1';
    const MIXINS = [
