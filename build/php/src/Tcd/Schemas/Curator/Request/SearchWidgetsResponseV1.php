...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:search-widgets-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:search-widgets-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:search-widgets-response:v1';
    const MIXINS = [
