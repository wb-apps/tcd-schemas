...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:search-timelines-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:search-timelines-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:search-timelines-request:v1';
    const MIXINS = [
