...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:search-teasers-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:search-teasers-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:search-teasers-response:v1';
    const MIXINS = [
