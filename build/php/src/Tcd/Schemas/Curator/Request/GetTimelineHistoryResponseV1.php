...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:get-timeline-history-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:get-timeline-history-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:get-timeline-history-response:v1';
    const MIXINS = [
