...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:search-widgets-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:search-widgets-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:search-widgets-request:v1';
    const MIXINS = [
