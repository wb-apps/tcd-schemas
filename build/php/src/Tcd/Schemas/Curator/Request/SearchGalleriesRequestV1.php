...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:search-galleries-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:search-galleries-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:search-galleries-request:v1';
    const MIXINS = [
