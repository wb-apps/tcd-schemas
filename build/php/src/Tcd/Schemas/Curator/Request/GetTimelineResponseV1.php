...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:get-timeline-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:get-timeline-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:get-timeline-response:v1';
    const MIXINS = [
