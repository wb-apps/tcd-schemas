...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:search-teasers-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:search-teasers-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:search-teasers-request:v1';
    const MIXINS = [
