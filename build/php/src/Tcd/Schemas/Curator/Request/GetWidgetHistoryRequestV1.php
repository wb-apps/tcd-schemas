...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:get-widget-history-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:get-widget-history-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:get-widget-history-request:v1';
    const MIXINS = [
