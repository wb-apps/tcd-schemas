...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:get-timeline-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:get-timeline-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:get-timeline-request:v1';
    const MIXINS = [
