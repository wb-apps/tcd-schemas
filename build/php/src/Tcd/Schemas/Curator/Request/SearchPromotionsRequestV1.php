...
{
    const SCHEMA_ID = 'pbj:tcd:curator:request:search-promotions-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:curator:request:search-promotions-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:curator:request:search-promotions-request:v1';
    const MIXINS = [
