...
{
    const SCHEMA_ID = 'pbj:tcd:boost:event:sponsor-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:event:sponsor-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:event:sponsor-marked-as-draft:v1';
    const MIXINS = [
