...
{
    const SCHEMA_ID = 'pbj:tcd:boost:event:sponsor-expired:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:event:sponsor-expired';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:event:sponsor-expired:v1';
    const MIXINS = [
