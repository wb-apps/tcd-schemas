...
{
    const SCHEMA_ID = 'pbj:tcd:boost:event:sponsor-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:event:sponsor-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:event:sponsor-updated:v1';
    const MIXINS = [
