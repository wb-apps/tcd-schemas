...
{
    const SCHEMA_ID = 'pbj:tcd:boost:event:sponsor-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:event:sponsor-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:event:sponsor-scheduled:v1';
    const MIXINS = [
