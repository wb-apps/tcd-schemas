...
{
    const SCHEMA_ID = 'pbj:tcd:boost:event:sponsor-renamed:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:event:sponsor-renamed';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:event:sponsor-renamed:v1';
    const MIXINS = [
