...
{
    const SCHEMA_ID = 'pbj:tcd:boost:event:sponsor-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:event:sponsor-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:event:sponsor-unpublished:v1';
    const MIXINS = [
