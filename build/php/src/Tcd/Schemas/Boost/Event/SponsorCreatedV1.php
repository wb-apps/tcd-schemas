...
{
    const SCHEMA_ID = 'pbj:tcd:boost:event:sponsor-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:event:sponsor-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:event:sponsor-created:v1';
    const MIXINS = [
