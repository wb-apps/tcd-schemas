...
{
    const SCHEMA_ID = 'pbj:tcd:boost:event:sponsor-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:event:sponsor-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:event:sponsor-marked-as-pending:v1';
    const MIXINS = [
