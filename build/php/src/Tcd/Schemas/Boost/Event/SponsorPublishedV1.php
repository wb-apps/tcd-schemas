...
{
    const SCHEMA_ID = 'pbj:tcd:boost:event:sponsor-published:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:event:sponsor-published';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:event:sponsor-published:v1';
    const MIXINS = [
