...
{
    const SCHEMA_ID = 'pbj:tcd:boost:event:sponsor-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:event:sponsor-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:event:sponsor-deleted:v1';
    const MIXINS = [
