...
{
    const SCHEMA_ID = 'pbj:tcd:boost:command:publish-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:command:publish-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:command:publish-sponsor:v1';
    const MIXINS = [
