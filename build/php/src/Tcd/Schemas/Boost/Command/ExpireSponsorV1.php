...
{
    const SCHEMA_ID = 'pbj:tcd:boost:command:expire-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:command:expire-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:command:expire-sponsor:v1';
    const MIXINS = [
