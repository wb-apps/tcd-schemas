...
{
    const SCHEMA_ID = 'pbj:tcd:boost:command:delete-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:command:delete-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:command:delete-sponsor:v1';
    const MIXINS = [
