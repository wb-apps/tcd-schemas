...
{
    const SCHEMA_ID = 'pbj:tcd:boost:command:mark-sponsor-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:command:mark-sponsor-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:command:mark-sponsor-as-pending:v1';
    const MIXINS = [
