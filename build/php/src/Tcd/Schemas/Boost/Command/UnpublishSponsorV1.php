...
{
    const SCHEMA_ID = 'pbj:tcd:boost:command:unpublish-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:command:unpublish-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:command:unpublish-sponsor:v1';
    const MIXINS = [
