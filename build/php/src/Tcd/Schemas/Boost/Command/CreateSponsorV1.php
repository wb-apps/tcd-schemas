...
{
    const SCHEMA_ID = 'pbj:tcd:boost:command:create-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:command:create-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:command:create-sponsor:v1';
    const MIXINS = [
