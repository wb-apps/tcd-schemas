...
{
    const SCHEMA_ID = 'pbj:tcd:boost:command:mark-sponsor-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:command:mark-sponsor-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:command:mark-sponsor-as-draft:v1';
    const MIXINS = [
