...
{
    const SCHEMA_ID = 'pbj:tcd:boost:command:rename-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:command:rename-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:command:rename-sponsor:v1';
    const MIXINS = [
