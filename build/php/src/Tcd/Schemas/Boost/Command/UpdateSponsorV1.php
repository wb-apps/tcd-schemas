...
{
    const SCHEMA_ID = 'pbj:tcd:boost:command:update-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:command:update-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:command:update-sponsor:v1';
    const MIXINS = [
