...
namespace Tcd\Schemas\Boost\Request;
...
{
    const SCHEMA_ID = 'pbj:tcd:boost:request:get-sponsor-history-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:request:get-sponsor-history-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:request:get-sponsor-history-response:v1';
    const MIXINS = [
