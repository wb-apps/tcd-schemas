...
{
    const SCHEMA_ID = 'pbj:tcd:boost:request:search-sponsors-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:request:search-sponsors-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:request:search-sponsors-request:v1';
    const MIXINS = [
