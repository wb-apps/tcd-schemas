...
{
    const SCHEMA_ID = 'pbj:tcd:boost:request:get-sponsor-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:request:get-sponsor-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:request:get-sponsor-request:v1';
    const MIXINS = [
