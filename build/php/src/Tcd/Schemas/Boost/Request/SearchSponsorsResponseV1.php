...
{
    const SCHEMA_ID = 'pbj:tcd:boost:request:search-sponsors-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:request:search-sponsors-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:request:search-sponsors-response:v1';
    const MIXINS = [
