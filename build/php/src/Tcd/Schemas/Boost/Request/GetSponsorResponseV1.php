...
{
    const SCHEMA_ID = 'pbj:tcd:boost:request:get-sponsor-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:boost:request:get-sponsor-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:boost:request:get-sponsor-response:v1';
    const MIXINS = [
