...
{
    const SCHEMA_ID = 'pbj:tcd:notify:node:android-notification:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:node:android-notification';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:node:android-notification:v1';
    const MIXINS = [
