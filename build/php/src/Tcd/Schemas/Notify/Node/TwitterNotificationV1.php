...
{
    const SCHEMA_ID = 'pbj:tcd:notify:node:twitter-notification:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:node:twitter-notification';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:node:twitter-notification:v1';
    const MIXINS = [
