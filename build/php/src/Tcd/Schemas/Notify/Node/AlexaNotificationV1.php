...
{
    const SCHEMA_ID = 'pbj:tcd:notify:node:alexa-notification:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:node:alexa-notification';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:node:alexa-notification:v1';
    const MIXINS = [
