...
{
    const SCHEMA_ID = 'pbj:tcd:notify:node:email-notification:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:node:email-notification';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:node:email-notification:v1';
    const MIXINS = [
