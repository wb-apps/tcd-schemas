...
{
    const SCHEMA_ID = 'pbj:tcd:notify:node:browser-notification:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:node:browser-notification';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:node:browser-notification:v1';
    const MIXINS = [
