...
{
    const SCHEMA_ID = 'pbj:tcd:notify:node:ios-notification:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:node:ios-notification';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:node:ios-notification:v1';
    const MIXINS = [
