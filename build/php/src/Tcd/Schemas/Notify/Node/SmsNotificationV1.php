...
{
    const SCHEMA_ID = 'pbj:tcd:notify:node:sms-notification:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:node:sms-notification';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:node:sms-notification:v1';
    const MIXINS = [
