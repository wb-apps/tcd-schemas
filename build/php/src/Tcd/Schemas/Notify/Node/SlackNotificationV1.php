...
{
    const SCHEMA_ID = 'pbj:tcd:notify:node:slack-notification:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:node:slack-notification';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:node:slack-notification:v1';
    const MIXINS = [
