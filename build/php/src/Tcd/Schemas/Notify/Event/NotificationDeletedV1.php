...
namespace Tcd\Schemas\Notify\Event;
...
{
    const SCHEMA_ID = 'pbj:tcd:notify:event:notification-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:event:notification-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:event:notification-deleted:v1';
    const MIXINS = [
