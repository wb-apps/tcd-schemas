...
{
    const SCHEMA_ID = 'pbj:tcd:notify:event:notification-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:event:notification-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:event:notification-created:v1';
    const MIXINS = [
