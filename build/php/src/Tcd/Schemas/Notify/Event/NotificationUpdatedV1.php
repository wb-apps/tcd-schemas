...
{
    const SCHEMA_ID = 'pbj:tcd:notify:event:notification-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:event:notification-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:event:notification-updated:v1';
    const MIXINS = [
