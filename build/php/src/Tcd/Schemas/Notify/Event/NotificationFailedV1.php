...
{
    const SCHEMA_ID = 'pbj:tcd:notify:event:notification-failed:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:event:notification-failed';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:event:notification-failed:v1';
    const MIXINS = [
