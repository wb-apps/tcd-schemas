...
{
    const SCHEMA_ID = 'pbj:tcd:notify:event:notification-sent:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:event:notification-sent';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:event:notification-sent:v1';
    const MIXINS = [
