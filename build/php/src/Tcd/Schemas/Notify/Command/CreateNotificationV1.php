...
{
    const SCHEMA_ID = 'pbj:tcd:notify:command:create-notification:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:command:create-notification';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:command:create-notification:v1';
    const MIXINS = [
