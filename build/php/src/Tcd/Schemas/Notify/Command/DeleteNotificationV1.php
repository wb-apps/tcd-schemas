...
{
    const SCHEMA_ID = 'pbj:tcd:notify:command:delete-notification:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:command:delete-notification';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:command:delete-notification:v1';
    const MIXINS = [
