...
{
    const SCHEMA_ID = 'pbj:tcd:notify:command:update-notification:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:command:update-notification';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:command:update-notification:v1';
    const MIXINS = [
