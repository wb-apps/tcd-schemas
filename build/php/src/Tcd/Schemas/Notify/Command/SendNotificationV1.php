...
{
    const SCHEMA_ID = 'pbj:tcd:notify:command:send-notification:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:command:send-notification';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:command:send-notification:v1';
    const MIXINS = [
