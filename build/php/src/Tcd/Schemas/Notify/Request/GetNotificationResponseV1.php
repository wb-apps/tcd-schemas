...
{
    const SCHEMA_ID = 'pbj:tcd:notify:request:get-notification-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:request:get-notification-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:request:get-notification-response:v1';
    const MIXINS = [
