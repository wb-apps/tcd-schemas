...
{
    const SCHEMA_ID = 'pbj:tcd:notify:request:get-notification-history-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:request:get-notification-history-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:request:get-notification-history-request:v1';
    const MIXINS = [
