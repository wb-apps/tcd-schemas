...
{
    const SCHEMA_ID = 'pbj:tcd:notify:request:get-notification-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:request:get-notification-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:request:get-notification-request:v1';
    const MIXINS = [
