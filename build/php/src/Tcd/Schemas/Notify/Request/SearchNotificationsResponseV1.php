...
{
    const SCHEMA_ID = 'pbj:tcd:notify:request:search-notifications-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:request:search-notifications-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:request:search-notifications-response:v1';
    const MIXINS = [
