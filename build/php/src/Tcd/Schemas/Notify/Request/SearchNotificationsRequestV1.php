...
{
    const SCHEMA_ID = 'pbj:tcd:notify:request:search-notifications-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:notify:request:search-notifications-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:notify:request:search-notifications-request:v1';
    const MIXINS = [
