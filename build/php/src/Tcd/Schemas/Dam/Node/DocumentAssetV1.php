...
namespace Tcd\Schemas\Dam\Node;
...
{
    const SCHEMA_ID = 'pbj:tcd:dam:node:document-asset:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:node:document-asset';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:node:document-asset:v1';
    const MIXINS = [
