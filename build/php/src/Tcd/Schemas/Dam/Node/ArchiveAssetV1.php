...
{
    const SCHEMA_ID = 'pbj:tcd:dam:node:archive-asset:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:node:archive-asset';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:node:archive-asset:v1';
    const MIXINS = [
