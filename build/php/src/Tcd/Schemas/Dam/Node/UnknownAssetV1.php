...
{
    const SCHEMA_ID = 'pbj:tcd:dam:node:unknown-asset:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:node:unknown-asset';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:node:unknown-asset:v1';
    const MIXINS = [
