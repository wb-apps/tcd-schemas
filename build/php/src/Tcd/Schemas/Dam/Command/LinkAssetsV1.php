...
{
    const SCHEMA_ID = 'pbj:tcd:dam:command:link-assets:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:command:link-assets';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:command:link-assets:v1';
    const MIXINS = [
