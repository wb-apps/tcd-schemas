...
{
    const SCHEMA_ID = 'pbj:tcd:dam:command:create-asset:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:command:create-asset';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:command:create-asset:v1';
    const MIXINS = [
