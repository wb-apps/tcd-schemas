...
{
    const SCHEMA_ID = 'pbj:tcd:dam:command:delete-asset:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:command:delete-asset';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:command:delete-asset:v1';
    const MIXINS = [
