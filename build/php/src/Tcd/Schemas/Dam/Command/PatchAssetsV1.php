...
{
    const SCHEMA_ID = 'pbj:tcd:dam:command:patch-assets:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:command:patch-assets';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:command:patch-assets:v1';
    const MIXINS = [
