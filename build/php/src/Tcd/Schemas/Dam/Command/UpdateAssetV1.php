...
{
    const SCHEMA_ID = 'pbj:tcd:dam:command:update-asset:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:command:update-asset';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:command:update-asset:v1';
    const MIXINS = [
