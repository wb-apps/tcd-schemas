...
{
    const SCHEMA_ID = 'pbj:tcd:dam:command:expire-asset:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:command:expire-asset';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:command:expire-asset:v1';
    const MIXINS = [
