...
namespace Tcd\Schemas\Dam\Command;
...
{
    const SCHEMA_ID = 'pbj:tcd:dam:command:reorder-gallery-assets:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:command:reorder-gallery-assets';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:command:reorder-gallery-assets:v1';
    const MIXINS = [
