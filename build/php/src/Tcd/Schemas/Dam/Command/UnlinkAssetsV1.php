...
{
    const SCHEMA_ID = 'pbj:tcd:dam:command:unlink-assets:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:command:unlink-assets';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:command:unlink-assets:v1';
    const MIXINS = [
