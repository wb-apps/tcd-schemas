...
{
    const SCHEMA_ID = 'pbj:tcd:dam:event:gallery-asset-reordered:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:event:gallery-asset-reordered';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:event:gallery-asset-reordered:v1';
    const MIXINS = [
