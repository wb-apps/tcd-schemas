...
{
    const SCHEMA_ID = 'pbj:tcd:dam:event:asset-patched:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:event:asset-patched';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:event:asset-patched:v1';
    const MIXINS = [
