...
{
    const SCHEMA_ID = 'pbj:tcd:dam:event:asset-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:event:asset-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:event:asset-updated:v1';
    const MIXINS = [
