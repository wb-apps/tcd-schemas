...
{
    const SCHEMA_ID = 'pbj:tcd:dam:event:asset-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:event:asset-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:event:asset-created:v1';
    const MIXINS = [
