...
{
    const SCHEMA_ID = 'pbj:tcd:dam:event:asset-linked:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:event:asset-linked';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:event:asset-linked:v1';
    const MIXINS = [
