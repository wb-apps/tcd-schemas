...
{
    const SCHEMA_ID = 'pbj:tcd:dam:event:asset-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:event:asset-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:event:asset-deleted:v1';
    const MIXINS = [
