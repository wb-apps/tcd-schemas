...
{
    const SCHEMA_ID = 'pbj:tcd:dam:event:asset-expired:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:event:asset-expired';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:event:asset-expired:v1';
    const MIXINS = [
