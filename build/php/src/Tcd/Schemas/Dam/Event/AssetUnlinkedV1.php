...
{
    const SCHEMA_ID = 'pbj:tcd:dam:event:asset-unlinked:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:event:asset-unlinked';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:event:asset-unlinked:v1';
    const MIXINS = [
