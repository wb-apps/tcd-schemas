...
{
    const SCHEMA_ID = 'pbj:tcd:dam:request:search-assets-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:request:search-assets-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:request:search-assets-response:v1';
    const MIXINS = [
