...
{
    const SCHEMA_ID = 'pbj:tcd:dam:request:get-asset-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:request:get-asset-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:request:get-asset-response:v1';
    const MIXINS = [
