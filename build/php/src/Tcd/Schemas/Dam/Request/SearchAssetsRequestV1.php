...
{
    const SCHEMA_ID = 'pbj:tcd:dam:request:search-assets-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:request:search-assets-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:request:search-assets-request:v1';
    const MIXINS = [
