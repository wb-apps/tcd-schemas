...
{
    const SCHEMA_ID = 'pbj:tcd:dam:request:get-upload-urls-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:request:get-upload-urls-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:request:get-upload-urls-response:v1';
    const MIXINS = [
