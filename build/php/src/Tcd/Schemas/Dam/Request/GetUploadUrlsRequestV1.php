...
{
    const SCHEMA_ID = 'pbj:tcd:dam:request:get-upload-urls-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:request:get-upload-urls-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:request:get-upload-urls-request:v1';
    const MIXINS = [
