...
{
    const SCHEMA_ID = 'pbj:tcd:dam:request:get-asset-history-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:request:get-asset-history-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:request:get-asset-history-response:v1';
    const MIXINS = [
