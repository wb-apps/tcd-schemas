...
{
    const SCHEMA_ID = 'pbj:tcd:dam:request:get-asset-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:dam:request:get-asset-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:dam:request:get-asset-request:v1';
    const MIXINS = [
