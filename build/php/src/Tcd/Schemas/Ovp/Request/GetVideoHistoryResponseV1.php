...
namespace Tcd\Schemas\Ovp\Request;
...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:request:get-video-history-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:request:get-video-history-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:request:get-video-history-response:v1';
    const MIXINS = [
