...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:request:search-videos-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:request:search-videos-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:request:search-videos-request:v1';
    const MIXINS = [
