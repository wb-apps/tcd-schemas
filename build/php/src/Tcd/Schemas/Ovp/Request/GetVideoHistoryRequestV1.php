...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:request:get-video-history-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:request:get-video-history-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:request:get-video-history-request:v1';
    const MIXINS = [
