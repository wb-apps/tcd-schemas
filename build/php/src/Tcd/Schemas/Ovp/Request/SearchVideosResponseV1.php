...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:request:search-videos-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:request:search-videos-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:request:search-videos-response:v1';
    const MIXINS = [
