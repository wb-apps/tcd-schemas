...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:request:get-video-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:request:get-video-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:request:get-video-response:v1';
    const MIXINS = [
