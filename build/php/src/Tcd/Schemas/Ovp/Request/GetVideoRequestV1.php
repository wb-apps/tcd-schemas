...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:request:get-video-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:request:get-video-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:request:get-video-request:v1';
    const MIXINS = [
