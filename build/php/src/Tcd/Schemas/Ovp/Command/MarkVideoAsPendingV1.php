...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:command:mark-video-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:command:mark-video-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:command:mark-video-as-pending:v1';
    const MIXINS = [
