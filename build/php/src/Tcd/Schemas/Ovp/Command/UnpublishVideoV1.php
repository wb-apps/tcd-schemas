...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:command:unpublish-video:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:command:unpublish-video';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:command:unpublish-video:v1';
    const MIXINS = [
