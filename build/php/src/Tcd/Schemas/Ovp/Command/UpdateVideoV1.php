...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:command:update-video:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:command:update-video';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:command:update-video:v1';
    const MIXINS = [
