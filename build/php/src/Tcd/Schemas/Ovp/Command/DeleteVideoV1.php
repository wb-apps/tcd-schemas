...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:command:delete-video:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:command:delete-video';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:command:delete-video:v1';
    const MIXINS = [
