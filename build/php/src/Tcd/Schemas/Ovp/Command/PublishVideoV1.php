...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:command:publish-video:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:command:publish-video';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:command:publish-video:v1';
    const MIXINS = [
