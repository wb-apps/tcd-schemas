...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:command:rename-video:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:command:rename-video';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:command:rename-video:v1';
    const MIXINS = [
