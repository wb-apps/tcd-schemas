...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:command:expire-video:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:command:expire-video';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:command:expire-video:v1';
    const MIXINS = [
