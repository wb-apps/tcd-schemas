...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:command:mark-video-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:command:mark-video-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:command:mark-video-as-draft:v1';
    const MIXINS = [
