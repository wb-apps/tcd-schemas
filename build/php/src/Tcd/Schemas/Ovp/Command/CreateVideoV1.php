...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:command:create-video:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:command:create-video';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:command:create-video:v1';
    const MIXINS = [
