...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:event:video-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:event:video-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:event:video-created:v1';
    const MIXINS = [
