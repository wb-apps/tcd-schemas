...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:event:video-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:event:video-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:event:video-scheduled:v1';
    const MIXINS = [
