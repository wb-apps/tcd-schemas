...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:event:video-expired:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:event:video-expired';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:event:video-expired:v1';
    const MIXINS = [
