...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:event:video-renamed:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:event:video-renamed';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:event:video-renamed:v1';
    const MIXINS = [
