...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:event:video-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:event:video-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:event:video-marked-as-draft:v1';
    const MIXINS = [
