...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:event:video-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:event:video-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:event:video-unpublished:v1';
    const MIXINS = [
