...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:event:video-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:event:video-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:event:video-marked-as-pending:v1';
    const MIXINS = [
