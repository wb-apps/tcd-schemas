...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:event:video-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:event:video-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:event:video-deleted:v1';
    const MIXINS = [
