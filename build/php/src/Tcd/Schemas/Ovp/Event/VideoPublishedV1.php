...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:event:video-published:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:event:video-published';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:event:video-published:v1';
    const MIXINS = [
