...
{
    const SCHEMA_ID = 'pbj:tcd:ovp:event:video-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:ovp:event:video-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:ovp:event:video-updated:v1';
    const MIXINS = [
