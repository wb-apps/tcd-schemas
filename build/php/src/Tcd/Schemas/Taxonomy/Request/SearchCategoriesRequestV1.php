...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:request:search-categories-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:request:search-categories-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:request:search-categories-request:v1';
    const MIXINS = [
