...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:request:get-all-channels-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:request:get-all-channels-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:request:get-all-channels-response:v1';
    const MIXINS = [
