...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:request:search-categories-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:request:search-categories-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:request:search-categories-response:v1';
    const MIXINS = [
