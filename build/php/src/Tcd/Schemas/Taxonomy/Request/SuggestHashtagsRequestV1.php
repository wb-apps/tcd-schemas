...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:request:suggest-hashtags-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:request:suggest-hashtags-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:request:suggest-hashtags-request:v1';
    const MIXINS = [
