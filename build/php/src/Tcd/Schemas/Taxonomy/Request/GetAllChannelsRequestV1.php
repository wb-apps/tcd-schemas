...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:request:get-all-channels-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:request:get-all-channels-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:request:get-all-channels-request:v1';
    const MIXINS = [
