...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:request:get-channel-history-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:request:get-channel-history-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:request:get-channel-history-request:v1';
    const MIXINS = [
