...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:request:suggest-hashtags-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:request:suggest-hashtags-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:request:suggest-hashtags-response:v1';
    const MIXINS = [
