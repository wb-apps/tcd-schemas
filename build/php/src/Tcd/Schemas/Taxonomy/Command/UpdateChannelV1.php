...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:command:update-channel:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:command:update-channel';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:command:update-channel:v1';
    const MIXINS = [
