...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:command:create-category:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:command:create-category';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:command:create-category:v1';
    const MIXINS = [
