...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:command:rename-channel:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:command:rename-channel';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:command:rename-channel:v1';
    const MIXINS = [
