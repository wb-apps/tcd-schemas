...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:command:delete-category:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:command:delete-category';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:command:delete-category:v1';
    const MIXINS = [
