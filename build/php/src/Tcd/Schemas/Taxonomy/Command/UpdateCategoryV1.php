...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:command:update-category:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:command:update-category';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:command:update-category:v1';
    const MIXINS = [
