...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:command:delete-channel:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:command:delete-channel';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:command:delete-channel:v1';
    const MIXINS = [
