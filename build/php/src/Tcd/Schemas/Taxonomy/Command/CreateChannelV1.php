...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:command:create-channel:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:command:create-channel';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:command:create-channel:v1';
    const MIXINS = [
