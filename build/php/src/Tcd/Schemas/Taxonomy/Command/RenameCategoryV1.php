...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:command:rename-category:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:command:rename-category';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:command:rename-category:v1';
    const MIXINS = [
