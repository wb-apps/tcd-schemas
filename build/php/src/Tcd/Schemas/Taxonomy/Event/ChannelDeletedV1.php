...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:event:channel-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:event:channel-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:event:channel-deleted:v1';
    const MIXINS = [
