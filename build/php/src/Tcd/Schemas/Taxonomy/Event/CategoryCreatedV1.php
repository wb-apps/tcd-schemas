...
namespace Tcd\Schemas\Taxonomy\Event;
...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:event:category-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:event:category-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:event:category-created:v1';
    const MIXINS = [
