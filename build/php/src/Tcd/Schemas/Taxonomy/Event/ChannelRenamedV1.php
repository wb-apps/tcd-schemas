...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:event:channel-renamed:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:event:channel-renamed';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:event:channel-renamed:v1';
    const MIXINS = [
