...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:event:category-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:event:category-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:event:category-deleted:v1';
    const MIXINS = [
