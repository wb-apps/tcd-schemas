...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:event:category-renamed:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:event:category-renamed';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:event:category-renamed:v1';
    const MIXINS = [
