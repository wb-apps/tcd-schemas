...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:event:channel-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:event:channel-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:event:channel-updated:v1';
    const MIXINS = [
