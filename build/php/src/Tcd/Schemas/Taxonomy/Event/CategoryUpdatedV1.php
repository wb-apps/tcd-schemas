...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:event:category-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:event:category-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:event:category-updated:v1';
    const MIXINS = [
