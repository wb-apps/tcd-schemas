...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:event:channel-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:event:channel-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:event:channel-created:v1';
    const MIXINS = [
