...
{
    const SCHEMA_ID = 'pbj:tcd:taxonomy:node:category:1-0-0';
    const SCHEMA_CURIE = 'tcd:taxonomy:node:category';
    const SCHEMA_CURIE_MAJOR = 'tcd:taxonomy:node:category:v1';
    const MIXINS = [
