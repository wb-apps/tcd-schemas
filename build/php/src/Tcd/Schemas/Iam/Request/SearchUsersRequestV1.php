...
{
    const SCHEMA_ID = 'pbj:tcd:iam:request:search-users-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:request:search-users-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:request:search-users-request:v1';
    const MIXINS = [
