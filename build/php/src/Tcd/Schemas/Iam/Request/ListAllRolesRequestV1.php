...
{
    const SCHEMA_ID = 'pbj:tcd:iam:request:list-all-roles-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:request:list-all-roles-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:request:list-all-roles-request:v1';
    const MIXINS = [
