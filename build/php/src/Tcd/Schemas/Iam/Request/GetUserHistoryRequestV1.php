...
{
    const SCHEMA_ID = 'pbj:tcd:iam:request:get-user-history-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:request:get-user-history-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:request:get-user-history-request:v1';
    const MIXINS = [
