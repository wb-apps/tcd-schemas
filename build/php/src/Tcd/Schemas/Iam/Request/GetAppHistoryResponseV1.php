...
{
    const SCHEMA_ID = 'pbj:tcd:iam:request:get-app-history-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:request:get-app-history-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:request:get-app-history-response:v1';
    const MIXINS = [
