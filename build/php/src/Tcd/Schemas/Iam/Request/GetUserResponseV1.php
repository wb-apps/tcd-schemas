...
{
    const SCHEMA_ID = 'pbj:tcd:iam:request:get-user-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:request:get-user-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:request:get-user-response:v1';
    const MIXINS = [
