...
{
    const SCHEMA_ID = 'pbj:tcd:iam:request:get-role-history-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:request:get-role-history-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:request:get-role-history-request:v1';
    const MIXINS = [
