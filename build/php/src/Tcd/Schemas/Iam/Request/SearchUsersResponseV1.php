...
{
    const SCHEMA_ID = 'pbj:tcd:iam:request:search-users-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:request:search-users-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:request:search-users-response:v1';
    const MIXINS = [
