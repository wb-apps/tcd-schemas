...
{
    const SCHEMA_ID = 'pbj:tcd:iam:request:list-all-roles-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:request:list-all-roles-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:request:list-all-roles-response:v1';
    const MIXINS = [
