...
{
    const SCHEMA_ID = 'pbj:tcd:iam:request:get-all-apps-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:request:get-all-apps-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:request:get-all-apps-response:v1';
    const MIXINS = [
