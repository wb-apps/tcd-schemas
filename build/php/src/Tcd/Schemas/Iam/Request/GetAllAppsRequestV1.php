...
{
    const SCHEMA_ID = 'pbj:tcd:iam:request:get-all-apps-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:request:get-all-apps-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:request:get-all-apps-request:v1';
    const MIXINS = [
