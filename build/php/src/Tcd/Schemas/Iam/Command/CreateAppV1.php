...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:create-app:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:create-app';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:create-app:v1';
    const MIXINS = [
