...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:create-user:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:create-user';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:create-user:v1';
    const MIXINS = [
