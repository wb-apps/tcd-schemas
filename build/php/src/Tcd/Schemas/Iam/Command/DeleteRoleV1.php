...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:delete-role:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:delete-role';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:delete-role:v1';
    const MIXINS = [
