...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:delete-app:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:delete-app';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:delete-app:v1';
    const MIXINS = [
