...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:update-app:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:update-app';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:update-app:v1';
    const MIXINS = [
