...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:revoke-roles-from-user:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:revoke-roles-from-user';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:revoke-roles-from-user:v1';
    const MIXINS = [
