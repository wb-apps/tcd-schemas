...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:update-user:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:update-user';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:update-user:v1';
    const MIXINS = [
