...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:delete-user:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:delete-user';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:delete-user:v1';
    const MIXINS = [
