...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:grant-roles-to-app:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:grant-roles-to-app';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:grant-roles-to-app:v1';
    const MIXINS = [
