...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:update-role:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:update-role';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:update-role:v1';
    const MIXINS = [
