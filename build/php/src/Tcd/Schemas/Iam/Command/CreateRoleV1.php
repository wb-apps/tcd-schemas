...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:create-role:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:create-role';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:create-role:v1';
    const MIXINS = [
