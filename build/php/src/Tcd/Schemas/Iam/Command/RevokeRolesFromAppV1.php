...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:revoke-roles-from-app:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:revoke-roles-from-app';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:revoke-roles-from-app:v1';
    const MIXINS = [
