...
{
    const SCHEMA_ID = 'pbj:tcd:iam:command:grant-roles-to-user:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:command:grant-roles-to-user';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:command:grant-roles-to-user:v1';
    const MIXINS = [
