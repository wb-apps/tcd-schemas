...
namespace Tcd\Schemas\Iam\Node;
...
{
    const SCHEMA_ID = 'pbj:tcd:iam:node:role:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:node:role';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:node:role:v1';
    const MIXINS = [
