...
{
    const SCHEMA_ID = 'pbj:tcd:iam:node:apple-news-app:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:node:apple-news-app';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:node:apple-news-app:v1';
    const MIXINS = [
