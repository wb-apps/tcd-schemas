...
{
    const SCHEMA_ID = 'pbj:tcd:iam:event:user-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:event:user-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:event:user-roles-revoked:v1';
    const MIXINS = [
