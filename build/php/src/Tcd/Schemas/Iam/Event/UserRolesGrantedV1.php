...
namespace Tcd\Schemas\Iam\Event;
...
{
    const SCHEMA_ID = 'pbj:tcd:iam:event:user-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:event:user-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:event:user-roles-granted:v1';
    const MIXINS = [
