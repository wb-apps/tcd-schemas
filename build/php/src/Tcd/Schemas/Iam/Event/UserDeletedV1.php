...
{
    const SCHEMA_ID = 'pbj:tcd:iam:event:user-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:event:user-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:event:user-deleted:v1';
    const MIXINS = [
