...
{
    const SCHEMA_ID = 'pbj:tcd:iam:event:app-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:event:app-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:event:app-roles-revoked:v1';
    const MIXINS = [
