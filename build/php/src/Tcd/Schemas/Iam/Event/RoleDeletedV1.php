...
{
    const SCHEMA_ID = 'pbj:tcd:iam:event:role-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:event:role-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:event:role-deleted:v1';
    const MIXINS = [
