...
{
    const SCHEMA_ID = 'pbj:tcd:iam:event:user-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:event:user-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:event:user-updated:v1';
    const MIXINS = [
