...
{
    const SCHEMA_ID = 'pbj:tcd:iam:event:role-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:event:role-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:event:role-created:v1';
    const MIXINS = [
