...
{
    const SCHEMA_ID = 'pbj:tcd:iam:event:user-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:event:user-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:event:user-created:v1';
    const MIXINS = [
