...
{
    const SCHEMA_ID = 'pbj:tcd:iam:event:app-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:event:app-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:event:app-roles-granted:v1';
    const MIXINS = [
