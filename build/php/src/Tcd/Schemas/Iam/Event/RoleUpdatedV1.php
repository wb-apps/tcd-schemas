...
{
    const SCHEMA_ID = 'pbj:tcd:iam:event:role-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:iam:event:role-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:iam:event:role-updated:v1';
    const MIXINS = [
