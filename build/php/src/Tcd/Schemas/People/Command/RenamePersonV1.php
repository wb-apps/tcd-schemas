...
{
    const SCHEMA_ID = 'pbj:tcd:people:command:rename-person:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:command:rename-person';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:command:rename-person:v1';
    const MIXINS = [
