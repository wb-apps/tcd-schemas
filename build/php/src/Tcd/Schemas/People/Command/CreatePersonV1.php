...
{
    const SCHEMA_ID = 'pbj:tcd:people:command:create-person:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:command:create-person';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:command:create-person:v1';
    const MIXINS = [
