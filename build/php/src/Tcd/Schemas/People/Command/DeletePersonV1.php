...
namespace Tcd\Schemas\People\Command;
...
{
    const SCHEMA_ID = 'pbj:tcd:people:command:delete-person:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:command:delete-person';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:command:delete-person:v1';
    const MIXINS = [
