...
{
    const SCHEMA_ID = 'pbj:tcd:people:command:update-person:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:command:update-person';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:command:update-person:v1';
    const MIXINS = [
