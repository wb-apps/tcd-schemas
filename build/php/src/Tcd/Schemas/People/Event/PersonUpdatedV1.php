...
{
    const SCHEMA_ID = 'pbj:tcd:people:event:person-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:event:person-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:event:person-updated:v1';
    const MIXINS = [
