...
{
    const SCHEMA_ID = 'pbj:tcd:people:event:person-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:event:person-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:event:person-deleted:v1';
    const MIXINS = [
