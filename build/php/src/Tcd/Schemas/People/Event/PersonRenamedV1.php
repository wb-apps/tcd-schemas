...
namespace Tcd\Schemas\People\Event;
...
{
    const SCHEMA_ID = 'pbj:tcd:people:event:person-renamed:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:event:person-renamed';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:event:person-renamed:v1';
    const MIXINS = [
