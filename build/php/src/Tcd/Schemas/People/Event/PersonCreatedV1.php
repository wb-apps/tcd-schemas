...
{
    const SCHEMA_ID = 'pbj:tcd:people:event:person-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:event:person-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:event:person-created:v1';
    const MIXINS = [
