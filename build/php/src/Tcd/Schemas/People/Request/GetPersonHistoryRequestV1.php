...
{
    const SCHEMA_ID = 'pbj:tcd:people:request:get-person-history-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:request:get-person-history-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:request:get-person-history-request:v1';
    const MIXINS = [
