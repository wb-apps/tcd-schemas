...
namespace Tcd\Schemas\People\Request;
...
{
    const SCHEMA_ID = 'pbj:tcd:people:request:get-person-history-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:request:get-person-history-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:request:get-person-history-response:v1';
    const MIXINS = [
