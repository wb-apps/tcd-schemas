...
{
    const SCHEMA_ID = 'pbj:tcd:people:request:get-person-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:request:get-person-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:request:get-person-response:v1';
    const MIXINS = [
