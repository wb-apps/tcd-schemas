...
{
    const SCHEMA_ID = 'pbj:tcd:people:request:search-people-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:request:search-people-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:request:search-people-response:v1';
    const MIXINS = [
