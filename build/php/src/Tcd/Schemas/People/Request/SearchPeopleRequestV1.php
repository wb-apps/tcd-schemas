...
{
    const SCHEMA_ID = 'pbj:tcd:people:request:search-people-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:people:request:search-people-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:people:request:search-people-request:v1';
    const MIXINS = [
