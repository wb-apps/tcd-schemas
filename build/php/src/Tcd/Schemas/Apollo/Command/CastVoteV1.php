...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:command:cast-vote:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:command:cast-vote';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:command:cast-vote:v1';
    const MIXINS = [
