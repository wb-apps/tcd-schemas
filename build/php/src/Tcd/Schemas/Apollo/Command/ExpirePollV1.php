...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:command:expire-poll:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:command:expire-poll';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:command:expire-poll:v1';
    const MIXINS = [
