...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:command:unpublish-poll:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:command:unpublish-poll';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:command:unpublish-poll:v1';
    const MIXINS = [
