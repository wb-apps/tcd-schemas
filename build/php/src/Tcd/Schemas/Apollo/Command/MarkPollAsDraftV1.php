...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:command:mark-poll-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:command:mark-poll-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:command:mark-poll-as-draft:v1';
    const MIXINS = [
