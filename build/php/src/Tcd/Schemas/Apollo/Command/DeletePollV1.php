...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:command:delete-poll:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:command:delete-poll';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:command:delete-poll:v1';
    const MIXINS = [
