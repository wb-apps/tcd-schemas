...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:command:update-poll:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:command:update-poll';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:command:update-poll:v1';
    const MIXINS = [
