...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:command:create-poll:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:command:create-poll';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:command:create-poll:v1';
    const MIXINS = [
