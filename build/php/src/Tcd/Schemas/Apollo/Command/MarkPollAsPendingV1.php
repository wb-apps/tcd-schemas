...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:command:mark-poll-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:command:mark-poll-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:command:mark-poll-as-pending:v1';
    const MIXINS = [
