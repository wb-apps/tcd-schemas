...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:command:publish-poll:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:command:publish-poll';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:command:publish-poll:v1';
    const MIXINS = [
