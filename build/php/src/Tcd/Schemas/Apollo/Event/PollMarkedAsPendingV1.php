...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:event:poll-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:event:poll-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:event:poll-marked-as-pending:v1';
    const MIXINS = [
