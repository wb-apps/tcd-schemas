...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:event:poll-published:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:event:poll-published';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:event:poll-published:v1';
    const MIXINS = [
