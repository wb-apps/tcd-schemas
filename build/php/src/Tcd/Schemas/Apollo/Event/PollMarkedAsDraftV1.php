...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:event:poll-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:event:poll-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:event:poll-marked-as-draft:v1';
    const MIXINS = [
