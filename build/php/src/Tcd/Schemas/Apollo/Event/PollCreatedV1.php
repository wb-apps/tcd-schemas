...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:event:poll-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:event:poll-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:event:poll-created:v1';
    const MIXINS = [
