...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:event:poll-expired:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:event:poll-expired';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:event:poll-expired:v1';
    const MIXINS = [
