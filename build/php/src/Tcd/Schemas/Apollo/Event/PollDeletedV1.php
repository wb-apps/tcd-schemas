...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:event:poll-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:event:poll-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:event:poll-deleted:v1';
    const MIXINS = [
