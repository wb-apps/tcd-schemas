...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:event:poll-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:event:poll-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:event:poll-scheduled:v1';
    const MIXINS = [
