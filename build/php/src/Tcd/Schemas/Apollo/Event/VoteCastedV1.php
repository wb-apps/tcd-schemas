...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:event:vote-casted:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:event:vote-casted';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:event:vote-casted:v1';
    const MIXINS = [
