...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:event:poll-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:event:poll-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:event:poll-unpublished:v1';
    const MIXINS = [
