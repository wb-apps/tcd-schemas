...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:event:poll-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:event:poll-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:event:poll-updated:v1';
    const MIXINS = [
