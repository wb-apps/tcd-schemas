...
{
    const SCHEMA_ID = 'pbj:tcd:apollo::poll-answer:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo::poll-answer';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo::poll-answer:v1';
    const MIXINS = [
