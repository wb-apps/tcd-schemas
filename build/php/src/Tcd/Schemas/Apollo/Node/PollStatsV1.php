...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:node:poll-stats:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:node:poll-stats';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:node:poll-stats:v1';
    const MIXINS = [
