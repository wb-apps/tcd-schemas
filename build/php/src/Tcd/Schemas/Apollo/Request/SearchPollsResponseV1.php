...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:request:search-polls-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:request:search-polls-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:request:search-polls-response:v1';
    const MIXINS = [
