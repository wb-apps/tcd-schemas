...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:request:get-poll-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:request:get-poll-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:request:get-poll-response:v1';
    const MIXINS = [
