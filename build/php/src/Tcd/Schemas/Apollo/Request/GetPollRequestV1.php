...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:request:get-poll-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:request:get-poll-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:request:get-poll-request:v1';
    const MIXINS = [
