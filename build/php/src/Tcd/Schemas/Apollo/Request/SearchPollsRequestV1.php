...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:request:search-polls-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:request:search-polls-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:request:search-polls-request:v1';
    const MIXINS = [
