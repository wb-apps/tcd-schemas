...
namespace Tcd\Schemas\Apollo\Request;
...
{
    const SCHEMA_ID = 'pbj:tcd:apollo:request:get-poll-history-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:apollo:request:get-poll-history-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:apollo:request:get-poll-history-response:v1';
    const MIXINS = [
