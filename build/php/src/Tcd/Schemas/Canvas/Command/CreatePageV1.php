...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:command:create-page:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:command:create-page';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:command:create-page:v1';
    const MIXINS = [
