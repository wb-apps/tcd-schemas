...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:command:rename-page:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:command:rename-page';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:command:rename-page:v1';
    const MIXINS = [
