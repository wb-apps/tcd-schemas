...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:command:mark-page-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:command:mark-page-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:command:mark-page-as-draft:v1';
    const MIXINS = [
