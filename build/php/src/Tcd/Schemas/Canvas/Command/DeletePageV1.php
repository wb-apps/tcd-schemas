...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:command:delete-page:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:command:delete-page';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:command:delete-page:v1';
    const MIXINS = [
