...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:command:expire-page:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:command:expire-page';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:command:expire-page:v1';
    const MIXINS = [
