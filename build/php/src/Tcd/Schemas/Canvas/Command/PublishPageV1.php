...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:command:publish-page:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:command:publish-page';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:command:publish-page:v1';
    const MIXINS = [
