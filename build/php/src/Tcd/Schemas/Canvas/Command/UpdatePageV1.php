...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:command:update-page:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:command:update-page';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:command:update-page:v1';
    const MIXINS = [
