...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:command:unpublish-page:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:command:unpublish-page';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:command:unpublish-page:v1';
    const MIXINS = [
