...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:command:mark-page-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:command:mark-page-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:command:mark-page-as-pending:v1';
    const MIXINS = [
