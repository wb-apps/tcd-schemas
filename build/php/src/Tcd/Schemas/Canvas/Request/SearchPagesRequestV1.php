...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:request:search-pages-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:request:search-pages-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:request:search-pages-request:v1';
    const MIXINS = [
