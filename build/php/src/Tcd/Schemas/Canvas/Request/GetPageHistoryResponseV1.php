...
namespace Tcd\Schemas\Canvas\Request;
...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:request:get-page-history-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:request:get-page-history-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:request:get-page-history-response:v1';
    const MIXINS = [
