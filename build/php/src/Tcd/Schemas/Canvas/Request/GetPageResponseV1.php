...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:request:get-page-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:request:get-page-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:request:get-page-response:v1';
    const MIXINS = [
