...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:request:search-pages-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:request:search-pages-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:request:search-pages-response:v1';
    const MIXINS = [
