...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:request:get-page-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:request:get-page-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:request:get-page-request:v1';
    const MIXINS = [
