...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:facebook-video-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:facebook-video-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:facebook-video-block:v1';
    const MIXINS = [
