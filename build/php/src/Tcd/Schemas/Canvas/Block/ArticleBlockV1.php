...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:article-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:article-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:article-block:v1';
    const MIXINS = [
