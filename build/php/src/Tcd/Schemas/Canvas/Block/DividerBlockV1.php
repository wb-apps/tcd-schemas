...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:divider-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:divider-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:divider-block:v1';
    const MIXINS = [
