...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:spotify-track-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:spotify-track-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:spotify-track-block:v1';
    const MIXINS = [
