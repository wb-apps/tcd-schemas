...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:tumblr-post-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:tumblr-post-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:tumblr-post-block:v1';
    const MIXINS = [
