...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:vimeo-video-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:vimeo-video-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:vimeo-video-block:v1';
    const MIXINS = [
