...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:soundcloud-audio-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:soundcloud-audio-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:soundcloud-audio-block:v1';
    const MIXINS = [
