...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:instagram-media-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:instagram-media-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:instagram-media-block:v1';
    const MIXINS = [
