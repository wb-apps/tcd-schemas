...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:poll-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:poll-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:poll-block:v1';
    const MIXINS = [
