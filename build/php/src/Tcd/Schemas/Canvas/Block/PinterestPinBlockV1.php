...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:pinterest-pin-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:pinterest-pin-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:pinterest-pin-block:v1';
    const MIXINS = [
