...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:image-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:image-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:image-block:v1';
    const MIXINS = [
