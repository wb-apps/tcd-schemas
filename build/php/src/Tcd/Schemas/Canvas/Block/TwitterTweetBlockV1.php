...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:twitter-tweet-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:twitter-tweet-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:twitter-tweet-block:v1';
    const MIXINS = [
