...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:audio-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:audio-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:audio-block:v1';
    const MIXINS = [
