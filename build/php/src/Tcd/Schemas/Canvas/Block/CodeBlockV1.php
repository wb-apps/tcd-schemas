...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:code-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:code-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:code-block:v1';
    const MIXINS = [
