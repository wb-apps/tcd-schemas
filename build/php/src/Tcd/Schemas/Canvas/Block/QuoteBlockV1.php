...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:quote-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:quote-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:quote-block:v1';
    const MIXINS = [
