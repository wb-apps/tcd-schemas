...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:eme-form-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:eme-form-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:eme-form-block:v1';
    const MIXINS = [
