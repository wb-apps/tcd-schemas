...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:youtube-video-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:youtube-video-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:youtube-video-block:v1';
    const MIXINS = [
