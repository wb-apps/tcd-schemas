...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:iframe-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:iframe-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:iframe-block:v1';
    const MIXINS = [
