...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:gallery-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:gallery-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:gallery-block:v1';
    const MIXINS = [
