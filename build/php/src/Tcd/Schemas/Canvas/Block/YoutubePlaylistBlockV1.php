...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:youtube-playlist-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:youtube-playlist-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:youtube-playlist-block:v1';
    const MIXINS = [
