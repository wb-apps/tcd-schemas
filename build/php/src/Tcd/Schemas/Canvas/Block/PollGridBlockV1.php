...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:poll-grid-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:poll-grid-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:poll-grid-block:v1';
    const MIXINS = [
