...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:imgur-post-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:imgur-post-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:imgur-post-block:v1';
    const MIXINS = [
