...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:google-map-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:google-map-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:google-map-block:v1';
    const MIXINS = [
