...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:heading-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:heading-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:heading-block:v1';
    const MIXINS = [
