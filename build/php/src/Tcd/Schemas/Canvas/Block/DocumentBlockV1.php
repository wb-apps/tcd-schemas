...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:block:document-block:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:block:document-block';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:block:document-block:v1';
    const MIXINS = [
