...
namespace Tcd\Schemas\Canvas\Event;
...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:event:page-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:event:page-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:event:page-marked-as-pending:v1';
    const MIXINS = [
