...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:event:page-renamed:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:event:page-renamed';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:event:page-renamed:v1';
    const MIXINS = [
