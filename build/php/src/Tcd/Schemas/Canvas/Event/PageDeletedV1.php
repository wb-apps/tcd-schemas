...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:event:page-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:event:page-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:event:page-deleted:v1';
    const MIXINS = [
