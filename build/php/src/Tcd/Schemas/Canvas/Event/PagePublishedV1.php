...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:event:page-published:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:event:page-published';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:event:page-published:v1';
    const MIXINS = [
