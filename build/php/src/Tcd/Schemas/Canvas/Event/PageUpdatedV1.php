...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:event:page-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:event:page-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:event:page-updated:v1';
    const MIXINS = [
