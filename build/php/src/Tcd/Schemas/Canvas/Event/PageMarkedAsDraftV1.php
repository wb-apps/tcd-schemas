...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:event:page-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:event:page-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:event:page-marked-as-draft:v1';
    const MIXINS = [
