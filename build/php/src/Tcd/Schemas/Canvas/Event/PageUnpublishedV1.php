...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:event:page-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:event:page-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:event:page-unpublished:v1';
    const MIXINS = [
