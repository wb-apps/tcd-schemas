...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:event:page-expired:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:event:page-expired';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:event:page-expired:v1';
    const MIXINS = [
