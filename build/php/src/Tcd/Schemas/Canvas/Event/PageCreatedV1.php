...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:event:page-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:event:page-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:event:page-created:v1';
    const MIXINS = [
