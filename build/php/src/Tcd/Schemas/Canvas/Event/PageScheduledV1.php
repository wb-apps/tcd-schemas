...
{
    const SCHEMA_ID = 'pbj:tcd:canvas:event:page-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tcd:canvas:event:page-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tcd:canvas:event:page-scheduled:v1';
    const MIXINS = [
