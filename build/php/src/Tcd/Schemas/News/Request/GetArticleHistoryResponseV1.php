...
namespace Tcd\Schemas\News\Request;
...
{
    const SCHEMA_ID = 'pbj:tcd:news:request:get-article-history-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:request:get-article-history-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:request:get-article-history-response:v1';
    const MIXINS = [
