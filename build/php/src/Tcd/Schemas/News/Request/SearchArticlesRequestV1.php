...
{
    const SCHEMA_ID = 'pbj:tcd:news:request:search-articles-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:request:search-articles-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:request:search-articles-request:v1';
    const MIXINS = [
