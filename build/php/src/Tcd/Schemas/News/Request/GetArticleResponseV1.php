...
{
    const SCHEMA_ID = 'pbj:tcd:news:request:get-article-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:request:get-article-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:request:get-article-response:v1';
    const MIXINS = [
