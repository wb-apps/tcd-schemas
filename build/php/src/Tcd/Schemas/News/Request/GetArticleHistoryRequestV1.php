...
{
    const SCHEMA_ID = 'pbj:tcd:news:request:get-article-history-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:request:get-article-history-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:request:get-article-history-request:v1';
    const MIXINS = [
