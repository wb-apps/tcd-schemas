...
{
    const SCHEMA_ID = 'pbj:tcd:news:request:search-articles-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:request:search-articles-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:request:search-articles-response:v1';
    const MIXINS = [
