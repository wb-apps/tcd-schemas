...
{
    const SCHEMA_ID = 'pbj:tcd:news:node:article-stats:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:node:article-stats';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:node:article-stats:v1';
    const MIXINS = [
