...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:rename-article:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:rename-article';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:rename-article:v1';
    const MIXINS = [
