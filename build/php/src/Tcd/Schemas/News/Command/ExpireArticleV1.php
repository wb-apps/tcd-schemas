...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:expire-article:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:expire-article';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:expire-article:v1';
    const MIXINS = [
