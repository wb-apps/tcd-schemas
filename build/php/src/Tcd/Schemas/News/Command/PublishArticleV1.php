...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:publish-article:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:publish-article';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:publish-article:v1';
    const MIXINS = [
