...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:update-article:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:update-article';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:update-article:v1';
    const MIXINS = [
