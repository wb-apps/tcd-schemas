...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:mark-article-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:mark-article-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:mark-article-as-draft:v1';
    const MIXINS = [
