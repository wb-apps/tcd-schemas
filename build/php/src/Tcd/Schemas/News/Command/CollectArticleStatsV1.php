...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:collect-article-stats:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:collect-article-stats';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:collect-article-stats:v1';
    const MIXINS = [
