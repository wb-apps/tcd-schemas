...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:remove-article-slotting:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:remove-article-slotting';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:remove-article-slotting:v1';
    const MIXINS = [
