...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:lock-article:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:lock-article';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:lock-article:v1';
    const MIXINS = [
