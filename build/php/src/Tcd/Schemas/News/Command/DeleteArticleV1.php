...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:delete-article:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:delete-article';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:delete-article:v1';
    const MIXINS = [
