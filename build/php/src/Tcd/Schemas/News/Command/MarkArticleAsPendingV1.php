...
namespace Tcd\Schemas\News\Command;
...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:mark-article-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:mark-article-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:mark-article-as-pending:v1';
    const MIXINS = [
