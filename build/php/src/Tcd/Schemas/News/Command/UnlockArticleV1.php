...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:unlock-article:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:unlock-article';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:unlock-article:v1';
    const MIXINS = [
