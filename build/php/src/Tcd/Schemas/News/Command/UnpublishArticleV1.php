...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:unpublish-article:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:unpublish-article';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:unpublish-article:v1';
    const MIXINS = [
