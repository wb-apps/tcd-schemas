...
{
    const SCHEMA_ID = 'pbj:tcd:news:command:create-article:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:command:create-article';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:command:create-article:v1';
    const MIXINS = [
