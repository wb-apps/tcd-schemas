...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-expired:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-expired';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-expired:v1';
    const MIXINS = [
