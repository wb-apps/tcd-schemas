...
namespace Tcd\Schemas\News\Event;
...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:apple-news-article-synced:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:apple-news-article-synced';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:apple-news-article-synced:v1';
    const MIXINS = [
