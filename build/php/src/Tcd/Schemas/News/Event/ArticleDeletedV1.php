...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-deleted:v1';
    const MIXINS = [
