...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-unlocked:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-unlocked';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-unlocked:v1';
    const MIXINS = [
