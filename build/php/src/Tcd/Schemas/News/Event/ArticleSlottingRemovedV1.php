...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-slotting-removed:v1';
    const MIXINS = [
