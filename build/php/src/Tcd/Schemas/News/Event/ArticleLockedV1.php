...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-locked:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-locked';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-locked:v1';
    const MIXINS = [
