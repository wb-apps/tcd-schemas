...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-stats-collected:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-stats-collected';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-stats-collected:v1';
    const MIXINS = [
