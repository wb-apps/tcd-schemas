...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-published:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-published';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-published:v1';
    const MIXINS = [
