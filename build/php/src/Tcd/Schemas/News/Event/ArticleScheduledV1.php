...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-scheduled:v1';
    const MIXINS = [
