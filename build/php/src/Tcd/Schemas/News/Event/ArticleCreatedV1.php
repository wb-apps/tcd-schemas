...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-created:v1';
    const MIXINS = [
