...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-marked-as-pending:v1';
    const MIXINS = [
