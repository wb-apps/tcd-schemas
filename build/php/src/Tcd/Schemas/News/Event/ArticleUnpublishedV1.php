...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-unpublished:v1';
    const MIXINS = [
