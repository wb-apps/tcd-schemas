...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-marked-as-draft:v1';
    const MIXINS = [
