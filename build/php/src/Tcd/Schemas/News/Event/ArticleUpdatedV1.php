...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-updated:v1';
    const MIXINS = [
