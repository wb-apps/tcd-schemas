...
{
    const SCHEMA_ID = 'pbj:tcd:news:event:article-renamed:1-0-0';
    const SCHEMA_CURIE = 'tcd:news:event:article-renamed';
    const SCHEMA_CURIE_MAJOR = 'tcd:news:event:article-renamed:v1';
    const MIXINS = [
