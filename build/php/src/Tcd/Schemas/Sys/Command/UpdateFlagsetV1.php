...
{
    const SCHEMA_ID = 'pbj:tcd:sys:command:update-flagset:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:command:update-flagset';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:command:update-flagset:v1';
    const MIXINS = [
