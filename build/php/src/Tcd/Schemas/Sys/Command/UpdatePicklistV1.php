...
{
    const SCHEMA_ID = 'pbj:tcd:sys:command:update-picklist:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:command:update-picklist';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:command:update-picklist:v1';
    const MIXINS = [
