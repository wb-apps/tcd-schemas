...
{
    const SCHEMA_ID = 'pbj:tcd:sys:command:create-flagset:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:command:create-flagset';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:command:create-flagset:v1';
    const MIXINS = [
