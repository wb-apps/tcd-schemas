...
{
    const SCHEMA_ID = 'pbj:tcd:sys:command:create-picklist:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:command:create-picklist';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:command:create-picklist:v1';
    const MIXINS = [
