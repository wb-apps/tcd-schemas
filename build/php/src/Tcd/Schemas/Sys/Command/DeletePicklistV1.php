...
namespace Tcd\Schemas\Sys\Command;
...
{
    const SCHEMA_ID = 'pbj:tcd:sys:command:delete-picklist:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:command:delete-picklist';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:command:delete-picklist:v1';
    const MIXINS = [
