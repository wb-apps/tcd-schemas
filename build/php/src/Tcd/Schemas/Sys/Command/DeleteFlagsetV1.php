...
{
    const SCHEMA_ID = 'pbj:tcd:sys:command:delete-flagset:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:command:delete-flagset';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:command:delete-flagset:v1';
    const MIXINS = [
