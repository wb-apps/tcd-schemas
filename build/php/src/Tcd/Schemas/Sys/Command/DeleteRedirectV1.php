...
{
    const SCHEMA_ID = 'pbj:tcd:sys:command:delete-redirect:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:command:delete-redirect';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:command:delete-redirect:v1';
    const MIXINS = [
