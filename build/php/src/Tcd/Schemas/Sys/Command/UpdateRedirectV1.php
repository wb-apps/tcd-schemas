...
{
    const SCHEMA_ID = 'pbj:tcd:sys:command:update-redirect:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:command:update-redirect';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:command:update-redirect:v1';
    const MIXINS = [
