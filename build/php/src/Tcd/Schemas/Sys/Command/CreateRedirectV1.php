...
{
    const SCHEMA_ID = 'pbj:tcd:sys:command:create-redirect:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:command:create-redirect';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:command:create-redirect:v1';
    const MIXINS = [
