...
{
    const SCHEMA_ID = 'pbj:tcd:sys:event:redirect-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:event:redirect-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:event:redirect-created:v1';
    const MIXINS = [
