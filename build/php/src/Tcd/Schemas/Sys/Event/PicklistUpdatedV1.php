...
{
    const SCHEMA_ID = 'pbj:tcd:sys:event:picklist-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:event:picklist-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:event:picklist-updated:v1';
    const MIXINS = [
