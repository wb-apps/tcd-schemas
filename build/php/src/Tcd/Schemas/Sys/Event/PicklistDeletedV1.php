...
{
    const SCHEMA_ID = 'pbj:tcd:sys:event:picklist-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:event:picklist-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:event:picklist-deleted:v1';
    const MIXINS = [
