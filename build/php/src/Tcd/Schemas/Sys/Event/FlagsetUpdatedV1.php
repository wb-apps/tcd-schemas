...
{
    const SCHEMA_ID = 'pbj:tcd:sys:event:flagset-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:event:flagset-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:event:flagset-updated:v1';
    const MIXINS = [
