...
{
    const SCHEMA_ID = 'pbj:tcd:sys:event:redirect-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:event:redirect-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:event:redirect-deleted:v1';
    const MIXINS = [
