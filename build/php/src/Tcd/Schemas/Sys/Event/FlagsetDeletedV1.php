...
{
    const SCHEMA_ID = 'pbj:tcd:sys:event:flagset-deleted:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:event:flagset-deleted';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:event:flagset-deleted:v1';
    const MIXINS = [
