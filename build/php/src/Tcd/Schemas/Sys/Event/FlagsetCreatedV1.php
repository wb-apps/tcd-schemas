...
{
    const SCHEMA_ID = 'pbj:tcd:sys:event:flagset-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:event:flagset-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:event:flagset-created:v1';
    const MIXINS = [
