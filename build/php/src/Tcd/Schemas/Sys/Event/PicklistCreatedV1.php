...
{
    const SCHEMA_ID = 'pbj:tcd:sys:event:picklist-created:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:event:picklist-created';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:event:picklist-created:v1';
    const MIXINS = [
