...
{
    const SCHEMA_ID = 'pbj:tcd:sys:event:redirect-updated:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:event:redirect-updated';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:event:redirect-updated:v1';
    const MIXINS = [
