...
{
    const SCHEMA_ID = 'pbj:tcd:sys:request:get-picklist-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:request:get-picklist-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:request:get-picklist-response:v1';
    const MIXINS = [
