...
{
    const SCHEMA_ID = 'pbj:tcd:sys:request:get-redirect-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:request:get-redirect-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:request:get-redirect-request:v1';
    const MIXINS = [
