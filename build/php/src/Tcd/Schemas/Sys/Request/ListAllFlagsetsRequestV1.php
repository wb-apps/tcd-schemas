...
{
    const SCHEMA_ID = 'pbj:tcd:sys:request:list-all-flagsets-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:request:list-all-flagsets-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:request:list-all-flagsets-request:v1';
    const MIXINS = [
