...
{
    const SCHEMA_ID = 'pbj:tcd:sys:request:get-flagset-history-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:request:get-flagset-history-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:request:get-flagset-history-request:v1';
    const MIXINS = [
