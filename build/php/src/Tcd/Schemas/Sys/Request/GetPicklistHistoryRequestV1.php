...
{
    const SCHEMA_ID = 'pbj:tcd:sys:request:get-picklist-history-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:request:get-picklist-history-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:request:get-picklist-history-request:v1';
    const MIXINS = [
