...
{
    const SCHEMA_ID = 'pbj:tcd:sys:request:list-all-picklists-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:request:list-all-picklists-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:request:list-all-picklists-request:v1';
    const MIXINS = [
