...
{
    const SCHEMA_ID = 'pbj:tcd:sys:request:list-all-picklists-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:request:list-all-picklists-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:request:list-all-picklists-response:v1';
    const MIXINS = [
