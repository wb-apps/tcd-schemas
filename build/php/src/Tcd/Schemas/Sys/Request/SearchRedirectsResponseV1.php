...
{
    const SCHEMA_ID = 'pbj:tcd:sys:request:search-redirects-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:request:search-redirects-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:request:search-redirects-response:v1';
    const MIXINS = [
