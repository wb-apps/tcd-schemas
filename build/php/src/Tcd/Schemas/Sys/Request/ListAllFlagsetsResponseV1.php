...
{
    const SCHEMA_ID = 'pbj:tcd:sys:request:list-all-flagsets-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:request:list-all-flagsets-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:request:list-all-flagsets-response:v1';
    const MIXINS = [
