...
{
    const SCHEMA_ID = 'pbj:tcd:sys:request:get-flagset-response:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:request:get-flagset-response';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:request:get-flagset-response:v1';
    const MIXINS = [
