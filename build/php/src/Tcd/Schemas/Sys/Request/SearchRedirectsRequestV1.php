...
{
    const SCHEMA_ID = 'pbj:tcd:sys:request:search-redirects-request:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:request:search-redirects-request';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:request:search-redirects-request:v1';
    const MIXINS = [
