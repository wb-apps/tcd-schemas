...
namespace Tcd\Schemas\Sys\Node;
...
{
    const SCHEMA_ID = 'pbj:tcd:sys:node:picklist:1-0-0';
    const SCHEMA_CURIE = 'tcd:sys:node:picklist';
    const SCHEMA_CURIE_MAJOR = 'tcd:sys:node:picklist:v1';
    const MIXINS = [
